                                                            ...
                                                            <tr>
                                                                ...
                                                                <?php if ($adendum_result) { ?>
                                                                    <?php foreach ($adendum_result as $key => $value) { ?>
                                                                        ...
                                                                        ?>
                                                                        <th class="table-warning text-center text-white" style="width: 150px;"><i class="fa fa-list" aria-hidden="true"></i> <?= $romawi_add ?>
                                                                            <hr>
                                                                            <i class="fa fa-calendar" aria-hidden="true"></i> <br>
                                                                            <?= $value['tanggal'] ?>
                                                                        </th>
                                                                        <th class="table-secondary text-center text-white" style="width: 130px;">
                                                                            <a href="javascript:;" style="font-size:11px;" class="btn btn-sm btn-danger btn-lg" onclick="ModalPenunjang('<?= $romawi_add ?>')"><i class="fas fa fa-file"></i> Dokumen Penunjang / Kontrak</a>
                                                                            <hr>
