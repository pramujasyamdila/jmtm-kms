                                        ...
                                        <div class="tab-content">
                                            <?php foreach ($result_sub_program as $key => $value) { ?>
                                                ...
                                                <div class="tab-pane fade show" id="kirun<?= $value['id_detail_sub_program_penyedia_jasa'] ?>">
                                                                ...
                                                                <table id="table_data" class="table table-bordered table-striped">
                                                                    ...
                                                                    <tfoot>
                                                                        <tr>
                                                                            ...
                                                                            <?php                                                                       ?>
                                                                            <td>
                                                                                <!-- <label style="font-size: 10px;" for=""> <?= "Rp " . number_format($total_hps_penyedia_1 + $total_hps_penyedia_2, 2, ',', '.') ?> 
                                                                            </label> -->
                                                                            </td>
                                                                            <td>
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal fade" data-backdrop="false" id="modal_urutan" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
