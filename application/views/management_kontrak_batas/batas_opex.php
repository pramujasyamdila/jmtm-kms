                                                                                        ...
                                                                                        <div class="dropdown-menu" role="menu">
                                                                                            <?php if ($value_opex[$nilai] == null || $value_opex[$nilai] == 0) { ?>
                                                                                                <?php if ($kondisi_detail_opex) { ?>
                                                                                                    <a onclick="modal_level_2_opex(<?= $value_opex['id_opex'] ?>,'tambah_level_2_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                ...
                                                                                <div class="btn-group">
                                                                                    ...
                                                                                    <div class="dropdown-menu" role="menu">
                                                                                        <?php if ($value_opex[$nilai] == null || $value_opex[$nilai] == 0) { ?>
                                                                                            <?php if ($kondisi_detail_opex) { ?>
                                                                                                <a onclick="modal_level_2_opex(<?= $value_opex['id_opex'] ?>,'tambah_level_2_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                <a onclick="modal_level_2_opex(<?= $value_opex['id_opex'] ?>,'tambah_level_2_opex_excel',null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                            <?php    } else { ?>
                                                                                                <a onclick="modal_level_2_opex(<?= $value_opex['id_opex'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                <a onclick="modal_level_2_opex(<?= $value_opex['id_opex'] ?>,'tambah_level_2_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                <a onclick="modal_level_2_opex(<?= $value_opex['id_opex'] ?>,'tambah_level_2_opex_excel',null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                            ...
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-footer">
                                                                                        ...
                                                                                        <a href="javascript:;" style="display: none;" id="button_update_nilai_level_2_opex" class="btn btn-success button_simpan" onclick="Simpan_level_2_opex(<?= $value_opex['id_opex'] ?>,'update_nilai_level_2_opex')">Simpan</a>
                                                                                        <a href="javascript:;" id="button_tambah_level_2_opex" class="btn btn-success button_simpan" onclick="Simpan_level_2_opex(<?= $value_opex['id_opex'] ?>,'tambah_level_2_opex')">Update</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                        ...
                                                                                        <div class="dropdown-menu" role="menu">
                                                                                            <?php if ($value_detail_opex[$nilai] == null || $value_detail_opex[$nilai] == 0) { ?>
                                                                                                <?php if ($kondisi_opex_detail_1) { ?>
                                                                                                    <a onclick="modal_level_3_opex(<?= $value_detail_opex['id_opex_detail'] ?>,'tambah_level_3_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                    <a onclick="modal_level_3_opex(<?= $value_detail_opex['id_opex_detail'] ?>,'edit_level_3_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                    <!-- UBAH urutan -->
                                                                                                    ...
                                                                                                    <a onclick="modal_level_3_opex(<?= $value_detail_opex['id_opex_detail'] ?>,'urutan_level_3_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                <?php    } else { ?>
                                                                                                    ...
                                                                                                    <a onclick="modal_level_3_opex(<?= $value_detail_opex['id_opex_detail'] ?>,'tambah_level_3_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                    <a onclick="modal_level_3_opex(<?= $value_detail_opex['id_opex_detail'] ?>,'hapus_level_3_opex')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                    <a onclick="modal_level_3_opex(<?= $value_detail_opex['id_opex_detail'] ?>,'edit_level_3_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                    <a onclick="modal_level_3_opex(<?= $value_detail_opex['id_opex_detail'] ?>,'tambah_level_3_opex_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                    <!-- UBAH urutan -->
                                                                                                    <a onclick="modal_level_3_opex(<?= $value_detail_opex['id_opex_detail'] ?>,'urutan_level_3_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                            ...
                                                                                            <?php } else { ?>
                                                                                                <?php if ($kondisi_opex_detail_1) { ?>
                                                                                                    <a onclick="modal_level_3_opex(<?= $value_detail_opex['id_opex_detail'] ?>,'tambah_level_3_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                    <a onclick="modal_level_3_opex(<?= $value_detail_opex['id_opex_detail'] ?>,'edit_level_3_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                    <a onclick="modal_level_3_opex(<?= $value_detail_opex['id_opex_detail'] ?>,'tambah_level_3_opex_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                    <!-- UBAH urutan -->
                                                                                                    <a onclick="modal_level_3_opex(<?= $value_detail_opex['id_opex_detail'] ?>,'urutan_level_3_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                <?php    } else { ?>
                                                                                                    <a onclick="modal_level_3_opex(<?= $value_detail_opex['id_opex_detail'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                    ...
                                                                    <div class="modal fade" data-backdrop="false" id="form_modal_level_3_opex" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                    <a href="javascript:;" style="display: none;" id="button_update_nilai_level_3_opex" class="btn btn-success button_simpan" onclick="Simpan_level_3_opex('update_nilai_level_3_opex')">Simpan</a>
                                                                                    <a href="javascript:;" id="button_tambah_level_3_opex" class="btn btn-success button_simpan" onclick="Simpan_level_3_opex('tambah_level_3_opex')">Update</a>
                                                                                    <a href="javascript:;" id="button_edit_level_3_opex" class="btn btn-success button_simpan" onclick="Simpan_level_3_opex('edit_level_3_opex')">Edit</a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                                        ...
                                                                                        <div class="btn-group">
                                                                                            ...
                                                                                            <div class="dropdown-menu" role="menu">
                                                                                                <?php if ($value_detail_opex_1[$nilai] == null || $value_detail_opex_1[$nilai] == 0) { ?>
                                                                                                    <?php if ($kondisi_opex_detail_1) { ?>
                                                                                                        <a onclick="modal_level_4_opex(<?= $value_detail_opex_1['id_detail_opex_1'] ?>,'tambah_level_4_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                        <a onclick="modal_level_4_opex(<?= $value_detail_opex_1['id_detail_opex_1'] ?>,'edit_level_4_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                        ...
                                                                                                        <a onclick="modal_level_4_opex(<?= $value_detail_opex_1['id_detail_opex_1'] ?>,'urutan_level_4_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                    <?php    } else { ?>
                                                                                                        ...
                                                                                                        <a onclick="modal_level_4_opex(<?= $value_detail_opex_1['id_detail_opex_1'] ?>,'tambah_level_4_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                        <a onclick="modal_level_4_opex(<?= $value_detail_opex_1['id_detail_opex_1'] ?>,'hapus_level_4_opex')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                        <a onclick="modal_level_4_opex(<?= $value_detail_opex_1['id_detail_opex_1'] ?>,'edit_level_4_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                        <a onclick="modal_level_4_opex(<?= $value_detail_opex_1['id_detail_opex_1'] ?>,'tambah_level_4_opex_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                        <a onclick="modal_level_4_opex(<?= $value_detail_opex_1['id_detail_opex_1'] ?>,'urutan_level_4_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                    <?php   }  ?>
                                                                                        ...
                                                                                        <div class="dropdown-menu" role="menu">
                                                                                            <?php if ($value_detail_opex_1[$nilai] == null || $value_detail_opex_1[$nilai] == 0) { ?>
                                                                                                <?php if ($kondisi_opex_detail_1) { ?>
                                                                                                    <a onclick="modal_level_4_opex(<?= $value_detail_opex_1['id_detail_opex_1'] ?>,'tambah_level_4_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                    <a onclick="modal_level_4_opex(<?= $value_detail_opex_1['id_detail_opex_1'] ?>,'edit_level_4_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                    <a onclick="modal_level_4_opex(<?= $value_detail_opex_1['id_detail_opex_1'] ?>,'tambah_level_4_opex_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                    <a onclick="modal_level_4_opex(<?= $value_detail_opex_1['id_detail_opex_1'] ?>,'urutan_level_4_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                <?php    } else { ?>
                                                                                                    <a onclick="modal_level_4_opex(<?= $value_detail_opex_1['id_detail_opex_1'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                    <a onclick="modal_level_4_opex(<?= $value_detail_opex_1['id_detail_opex_1'] ?>,'tambah_level_4_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                        ...
                                                                        <div class="modal fade" data-backdrop="false" id="form_modal_level_4_opex" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-footer">
                                                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                        <a href="javascript:;" style="display: none;" id="button_update_nilai_level_4_opex" class="btn btn-success button_simpan" onclick="Simpan_level_4_opex('update_nilai_level_4_opex')">Simpan</a>
                                                                                        <a href="javascript:;" id="button_tambah_level_4_opex" class="btn btn-success button_simpan" onclick="Simpan_level_4_opex('tambah_level_4_opex')">Update</a>
                                                                                        <a href="javascript:;" id="button_edit_level_4_opex" class="btn btn-success button_simpan" onclick="Simpan_level_4_opex('edit_level_4_opex')">Edit</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                                ...
                                                                                                <div class="dropdown-menu" role="menu">
                                                                                                    <?php if ($value_detail_opex_2[$nilai] == null || $value_detail_opex_2[$nilai] == 0) { ?>
                                                                                                        <?php if ($kondisi_opex_detail_2) { ?>
                                                                                                            <a onclick="modal_level_5_opex(<?= $value_detail_opex_2['id_detail_opex_2'] ?>,'tambah_level_5_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                            <a onclick="modal_level_5_opex(<?= $value_detail_opex_2['id_detail_opex_2'] ?>,'edit_level_5_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                            ...
                                                                                                            <a onclick="modal_level_5_opex(<?= $value_detail_opex_2['id_detail_opex_2'] ?>,'urutan_level_5_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                        <?php    } else { ?>
                                                                                                            ...
                                                                                                            <a onclick="modal_level_5_opex(<?= $value_detail_opex_2['id_detail_opex_2'] ?>,'tambah_level_5_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                            <a onclick="modal_level_5_opex(<?= $value_detail_opex_2['id_detail_opex_2'] ?>,'hapus_level_5_opex')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                            <a onclick="modal_level_5_opex(<?= $value_detail_opex_2['id_detail_opex_2'] ?>,'edit_level_5_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                            <a onclick="modal_level_5_opex(<?= $value_detail_opex_2['id_detail_opex_2'] ?>,'tambah_level_5_opex_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                            <a onclick="modal_level_5_opex(<?= $value_detail_opex_2['id_detail_opex_2'] ?>,'urutan_level_5_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                        <?php   }  ?>
                                                                                            ...
                                                                                            <div class="dropdown-menu" role="menu">
                                                                                                <?php if ($value_detail_opex_2[$nilai] == null || $value_detail_opex_2[$nilai] == 0) { ?>
                                                                                                    <?php if ($kondisi_opex_detail_2) { ?>
                                                                                                        <a onclick="modal_level_5_opex(<?= $value_detail_opex_2['id_detail_opex_2'] ?>,'tambah_level_5_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                        <a onclick="modal_level_5_opex(<?= $value_detail_opex_2['id_detail_opex_2'] ?>,'edit_level_5_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                        <a onclick="modal_level_5_opex(<?= $value_detail_opex_2['id_detail_opex_2'] ?>,'tambah_level_5_opex_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                        <a onclick="modal_level_5_opex(<?= $value_detail_opex_2['id_detail_opex_2'] ?>,'urutan_level_5_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                    <?php    } else { ?>
                                                                                                        <a onclick="modal_level_5_opex(<?= $value_detail_opex_2['id_detail_opex_2'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                        <a onclick="modal_level_5_opex(<?= $value_detail_opex_2['id_detail_opex_2'] ?>,'tambah_level_5_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                            ...
                                                                            <div class="modal fade" data-backdrop="false" id="form_modal_level_5_opex" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                <div class="modal-dialog" role="document">
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <div class="modal-footer">
                                                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                            <a href="javascript:;" style="display: none;" id="button_update_nilai_level_5_opex" class="btn btn-success button_simpan" onclick="Simpan_level_5_opex('update_nilai_level_5_opex')">Simpan</a>
                                                                                            <a href="javascript:;" id="button_tambah_level_5_opex" class="btn btn-success button_simpan" onclick="Simpan_level_5_opex('tambah_level_5_opex')">Update</a>
                                                                                            <a href="javascript:;" id="button_edit_level_5_opex" class="btn btn-success button_simpan" onclick="Simpan_level_5_opex('edit_level_5_opex')">Edit</a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                                    ...
                                                                                                    <div class="dropdown-menu" role="menu">
                                                                                                        <?php if ($value_detail_opex_3[$nilai] == null || $value_detail_opex_3[$nilai] == 0) { ?>
                                                                                                            <?php if ($kondisi_opex_detail_4) { ?>
                                                                                                                <a onclick="modal_level_6_opex(<?= $value_detail_opex_3['id_detail_opex_3'] ?>,'tambah_level_6_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                <a onclick="modal_level_6_opex(<?= $value_detail_opex_3['id_detail_opex_3'] ?>,'edit_level_6_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                ...
                                                                                                                <a onclick="modal_level_6_opex(<?= $value_detail_opex_3['id_detail_opex_3'] ?>,'urutan_level_6_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                            <?php    } else { ?>
                                                                                                                ...
                                                                                                                <a onclick="modal_level_6_opex(<?= $value_detail_opex_3['id_detail_opex_3'] ?>,'tambah_level_6_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                <a onclick="modal_level_6_opex(<?= $value_detail_opex_3['id_detail_opex_3'] ?>,'hapus_level_6_opex')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                <a onclick="modal_level_6_opex(<?= $value_detail_opex_3['id_detail_opex_3'] ?>,'edit_level_6_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                <a onclick="modal_level_6_opex(<?= $value_detail_opex_3['id_detail_opex_3'] ?>,'tambah_level_6_opex_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                ...
                                                                                                <div class="dropdown-menu" role="menu">
                                                                                                    <?php if ($value_detail_opex_3[$nilai] == null || $value_detail_opex_3[$nilai] == 0) { ?>
                                                                                                        <?php if ($kondisi_opex_detail_4) { ?>
                                                                                                            <a onclick="modal_level_6_opex(<?= $value_detail_opex_3['id_detail_opex_3'] ?>,'tambah_level_6_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                            <a onclick="modal_level_6_opex(<?= $value_detail_opex_3['id_detail_opex_3'] ?>,'edit_level_6_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                            <a onclick="modal_level_6_opex(<?= $value_detail_opex_3['id_detail_opex_3'] ?>,'tambah_level_6_opex_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                            <a onclick="modal_level_6_opex(<?= $value_detail_opex_3['id_detail_opex_3'] ?>,'urutan_level_6_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                        <?php    } else { ?>
                                                                                                            <a onclick="modal_level_6_opex(<?= $value_detail_opex_3['id_detail_opex_3'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                            <a onclick="modal_level_6_opex(<?= $value_detail_opex_3['id_detail_opex_3'] ?>,'tambah_level_6_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                ...
                                                                                <div class="modal fade" data-backdrop="false" id="form_modal_level_6_opex" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                    <div class="modal-dialog" role="document">
                                                                                        <div class="modal-content">
                                                                                            ...
                                                                                            <div class="modal-footer">
                                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                <a href="javascript:;" style="display: none;" id="button_update_nilai_level_6_opex" class="btn btn-success button_simpan" onclick="Simpan_level_6_opex('update_nilai_level_6_opex')">Simpan</a>
                                                                                                <a href="javascript:;" id="button_tambah_level_6_opex" class="btn btn-success button_simpan" onclick="Simpan_level_6_opex('tambah_level_6_opex')">Update</a>
                                                                                                <a href="javascript:;" id="button_edit_level_6_opex" class="btn btn-success button_simpan" onclick="Simpan_level_6_opex('edit_level_6_opex')">Edit</a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                                        ...
                                                                                                        <div class="dropdown-menu" role="menu">
                                                                                                            <?php if ($value_detail_opex_4[$nilai] == null || $value_detail_opex_4[$nilai] == 0) { ?>
                                                                                                                <?php if ($kondisi_opex_detail_5) { ?>
                                                                                                                    <a onclick="modal_level_7_opex(<?= $value_detail_opex_4['id_detail_opex_4'] ?>,'tambah_level_7_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                    <a onclick="modal_level_7_opex(<?= $value_detail_opex_4['id_detail_opex_4'] ?>,'edit_level_7_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                    <a onclick="modal_level_7_opex(<?= $value_detail_opex_4['id_detail_opex_4'] ?>,'urutan_level_7_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                <?php    } else { ?>
                                                                                                                    ...
                                                                                                                    <a onclick="modal_level_7_opex(<?= $value_detail_opex_4['id_detail_opex_4'] ?>,'tambah_level_7_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                    <a onclick="modal_level_7_opex(<?= $value_detail_opex_4['id_detail_opex_4'] ?>,'hapus_level_7_opex')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                    <a onclick="modal_level_7_opex(<?= $value_detail_opex_4['id_detail_opex_4'] ?>,'edit_level_7_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                    ...
                                                                                                    <div class="dropdown-menu" role="menu">
                                                                                                        <?php if ($value_detail_opex_4[$nilai] == null || $value_detail_opex_4[$nilai] == 0) { ?>
                                                                                                            <?php if ($kondisi_opex_detail_5) { ?>
                                                                                                                <a onclick="modal_level_7_opex(<?= $value_detail_opex_4['id_detail_opex_4'] ?>,'tambah_level_7_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                <a onclick="modal_level_7_opex(<?= $value_detail_opex_4['id_detail_opex_4'] ?>,'edit_level_7_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                <a onclick="modal_level_7_opex(<?= $value_detail_opex_4['id_detail_opex_4'] ?>,'tambah_level_7_opex_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                <a onclick="modal_level_7_opex(<?= $value_detail_opex_4['id_detail_opex_4'] ?>,'urutan_level_7_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                            <?php    } else { ?>
                                                                                                                <a onclick="modal_level_7_opex(<?= $value_detail_opex_4['id_detail_opex_4'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                <a onclick="modal_level_7_opex(<?= $value_detail_opex_4['id_detail_opex_4'] ?>,'tambah_level_7_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                    ...
                                                                                    <div class="modal fade" data-backdrop="false" id="form_modal_level_7_opex" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                        <div class="modal-dialog" role="document">
                                                                                            <div class="modal-content">
                                                                                                ...
                                                                                                <div class="modal-footer">
                                                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                    <a href="javascript:;" style="display: none;" id="button_update_nilai_level_7_opex" class="btn btn-success button_simpan" onclick="Simpan_level_7_opex('update_nilai_level_7_opex')">Simpan</a>
                                                                                                    <a href="javascript:;" id="button_tambah_level_7_opex" class="btn btn-success button_simpan" onclick="Simpan_level_7_opex('tambah_level_7_opex')">Update</a>
                                                                                                    <a href="javascript:;" id="button_edit_level_7_opex" class="btn btn-success button_simpan" onclick="Simpan_level_7_opex('edit_level_7_opex')">Edit</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                                            ...
                                                                                                            <div class="dropdown-menu" role="menu">
                                                                                                                <?php if ($value_detail_opex_5[$nilai] == null || $value_detail_opex_5[$nilai] == 0) { ?>
                                                                                                                    <?php if ($kondisi_opex_detail_6) { ?>
                                                                                                                        <a onclick="modal_level_8_opex(<?= $value_detail_opex_5['id_detail_opex_5'] ?>,'tambah_level_8_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                        <a onclick="modal_level_8_opex(<?= $value_detail_opex_5['id_detail_opex_5'] ?>,'edit_level_8_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                        ...
                                                                                                                        <a onclick="modal_level_8_opex(<?= $value_detail_opex_5['id_detail_opex_5'] ?>,'urutan_level_8_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                    <?php    } else { ?>
                                                                                                                        ...
                                                                                                                        <a onclick="modal_level_8_opex(<?= $value_detail_opex_5['id_detail_opex_5'] ?>,'tambah_level_8_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                        <a onclick="modal_level_8_opex(<?= $value_detail_opex_5['id_detail_opex_5'] ?>,'hapus_level_8_opex')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                        <a onclick="modal_level_8_opex(<?= $value_detail_opex_5['id_detail_opex_5'] ?>,'edit_level_8_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                        <a onclick="modal_level_8_opex(<?= $value_detail_opex_5['id_detail_opex_5'] ?>,'tambah_level_8_opex_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                        <a onclick="modal_level_8_opex(<?= $value_detail_opex_5['id_detail_opex_5'] ?>,'urutan_level_8_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                    <?php   }  ?>
                                                                                                        ...
                                                                                                        <div class="dropdown-menu" role="menu">
                                                                                                            <?php if ($value_detail_opex_5[$nilai] == null || $value_detail_opex_5[$nilai] == 0) { ?>
                                                                                                                <?php if ($kondisi_opex_detail_6) { ?>
                                                                                                                    <a onclick="modal_level_8_opex(<?= $value_detail_opex_5['id_detail_opex_5'] ?>,'tambah_level_8_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                    <a onclick="modal_level_8_opex(<?= $value_detail_opex_5['id_detail_opex_5'] ?>,'edit_level_8_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                    <a onclick="modal_level_8_opex(<?= $value_detail_opex_5['id_detail_opex_5'] ?>,'tambah_level_8_opex_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                    <a onclick="modal_level_8_opex(<?= $value_detail_opex_5['id_detail_opex_5'] ?>,'urutan_level_8_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                <?php    } else { ?>
                                                                                                                    <a onclick="modal_level_8_opex(<?= $value_detail_opex_5['id_detail_opex_5'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                    <a onclick="modal_level_8_opex(<?= $value_detail_opex_5['id_detail_opex_5'] ?>,'tambah_level_8_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                        ...
                                                                                        <div class="modal fade" data-backdrop="false" id="form_modal_level_8_opex" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                            <div class="modal-dialog" role="document">
                                                                                                <div class="modal-content">
                                                                                                    ...
                                                                                                    <div class="modal-footer">
                                                                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                        <a href="javascript:;" style="display: none;" id="button_update_nilai_level_8_opex" class="btn btn-success button_simpan" onclick="Simpan_level_8_opex('update_nilai_level_8_opex')">Simpan</a>
                                                                                                        <a href="javascript:;" id="button_tambah_level_8_opex" class="btn btn-success button_simpan" onclick="Simpan_level_8_opex('tambah_level_8_opex')">Update</a>
                                                                                                        <a href="javascript:;" id="button_edit_level_8_opex" class="btn btn-success button_simpan" onclick="Simpan_level_8_opex('edit_level_8_opex')">Edit</a>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                                                ...
                                                                                                                <div class="dropdown-menu" role="menu">
                                                                                                                    <?php if ($value_detail_opex_6[$nilai] == null || $value_detail_opex_6[$nilai] == 0) { ?>
                                                                                                                        <?php if ($kondisi_opex_detail_7) { ?>
                                                                                                                            <a onclick="modal_level_9_opex(<?= $value_detail_opex_6['id_detail_opex_6'] ?>,'tambah_level_9_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                            <a onclick="modal_level_9_opex(<?= $value_detail_opex_6['id_detail_opex_6'] ?>,'edit_level_9_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                            ...
                                                                                                                            <a onclick="modal_level_9_opex(<?= $value_detail_opex_6['id_detail_opex_6'] ?>,'urutan_level_9_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                        <?php    } else { ?>
                                                                                                                            ...
                                                                                                                            <a onclick="modal_level_9_opex(<?= $value_detail_opex_6['id_detail_opex_6'] ?>,'tambah_level_9_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                            <a onclick="modal_level_9_opex(<?= $value_detail_opex_6['id_detail_opex_6'] ?>,'hapus_level_9_opex')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                            <a onclick="modal_level_9_opex(<?= $value_detail_opex_6['id_detail_opex_6'] ?>,'edit_level_9_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                            <a onclick="modal_level_9_opex(<?= $value_detail_opex_6['id_detail_opex_6'] ?>,'tambah_level_9_opex_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                            <a onclick="modal_level_9_opex(<?= $value_detail_opex_6['id_detail_opex_6'] ?>,'urutan_level_9_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                        <?php   }  ?>
                                                                                                            ...
                                                                                                            <div class="dropdown-menu" role="menu">
                                                                                                                <?php if ($value_detail_opex_6[$nilai] == null || $value_detail_opex_6[$nilai] == 0) { ?>
                                                                                                                    <?php if ($kondisi_opex_detail_7) { ?>
                                                                                                                        <a onclick="modal_level_9_opex(<?= $value_detail_opex_6['id_detail_opex_6'] ?>,'tambah_level_9_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                        <a onclick="modal_level_9_opex(<?= $value_detail_opex_6['id_detail_opex_6'] ?>,'edit_level_9_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                        <a onclick="modal_level_9_opex(<?= $value_detail_opex_6['id_detail_opex_6'] ?>,'tambah_level_9_opex_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                        <a onclick="modal_level_9_opex(<?= $value_detail_opex_6['id_detail_opex_6'] ?>,'urutan_level_9_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                    <?php    } else { ?>
                                                                                                                        <a onclick="modal_level_9_opex(<?= $value_detail_opex_6['id_detail_opex_6'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                        <a onclick="modal_level_9_opex(<?= $value_detail_opex_6['id_detail_opex_6'] ?>,'tambah_level_9_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                            ...
                                                                                            <div class="modal fade" data-backdrop="false" id="form_modal_level_9_opex" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                                <div class="modal-dialog" role="document">
                                                                                                    <div class="modal-content">
                                                                                                        ...
                                                                                                        <div class="modal-footer">
                                                                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                            <a href="javascript:;" style="display: none;" id="button_update_nilai_level_9_opex" class="btn btn-success button_simpan" onclick="Simpan_level_9_opex('update_nilai_level_9_opex')">Simpan</a>
                                                                                                            <a href="javascript:;" id="button_tambah_level_9_opex" class="btn btn-success button_simpan" onclick="Simpan_level_9_opex('tambah_level_9_opex')">Update</a>
                                                                                                            <a href="javascript:;" id="button_edit_level_9_opex" class="btn btn-success button_simpan" onclick="Simpan_level_9_opex('edit_level_9_opex')">Edit</a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                                                ...
                                                                                                                <div class="btn-group">
                                                                                                                    ...
                                                                                                                    <div class="dropdown-menu" role="menu">
                                                                                                                        <?php if ($value_detail_opex_7[$nilai] == null || $value_detail_opex_7[$nilai] == 0) { ?>
                                                                                                                            <?php if ($kondisi_opex_detail_7) { ?>
                                                                                                                                <a onclick="modal_level_10_opex(<?= $value_detail_opex_7['id_detail_opex_7'] ?>,'tambah_level_10_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                <a onclick="modal_level_10_opex(<?= $value_detail_opex_7['id_detail_opex_7'] ?>,'edit_level_10_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                ...
                                                                                                                                <a onclick="modal_level_10_opex(<?= $value_detail_opex_7['id_detail_opex_7'] ?>,'urutan_level_10_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                            <?php    } else { ?>
                                                                                                                                ...
                                                                                                                                <a onclick="modal_level_10_opex(<?= $value_detail_opex_7['id_detail_opex_7'] ?>,'tambah_level_10_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                <a onclick="modal_level_10_opex(<?= $value_detail_opex_7['id_detail_opex_7'] ?>,'hapus_level_10_opex')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                                <a onclick="modal_level_10_opex(<?= $value_detail_opex_7['id_detail_opex_7'] ?>,'edit_level_10_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                <a onclick="modal_level_10_opex(<?= $value_detail_opex_7['id_detail_opex_7'] ?>,'tambah_level_10_opex_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                                <a onclick="modal_level_10_opex(<?= $value_detail_opex_7['id_detail_opex_7'] ?>,'urutan_level_10_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                            <?php   }  ?>
                                                                                                                ...
                                                                                                                <div class="dropdown-menu" role="menu">
                                                                                                                    <?php if ($value_detail_opex_7[$nilai] == null || $value_detail_opex_7[$nilai] == 0) { ?>
                                                                                                                        <?php if ($kondisi_opex_detail_8) { ?>
                                                                                                                            <a onclick="modal_level_10_opex(<?= $value_detail_opex_7['id_detail_opex_7'] ?>,'tambah_level_10_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                            <a onclick="modal_level_10_opex(<?= $value_detail_opex_7['id_detail_opex_7'] ?>,'edit_level_10_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                            <a onclick="modal_level_10_opex(<?= $value_detail_opex_7['id_detail_opex_7'] ?>,'tambah_level_10_opex_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                            <a onclick="modal_level_10_opex(<?= $value_detail_opex_7['id_detail_opex_7'] ?>,'urutan_level_10_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                        <?php    } else { ?>
                                                                                                                            <a onclick="modal_level_10_opex(<?= $value_detail_opex_7['id_detail_opex_7'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                            <a onclick="modal_level_10_opex(<?= $value_detail_opex_7['id_detail_opex_7'] ?>,'tambah_level_10_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                ...
                                                                                                <div class="modal fade" data-backdrop="false" id="form_modal_level_10_opex" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                                    <div class="modal-dialog" role="document">
                                                                                                        <div class="modal-content">
                                                                                                            ...
                                                                                                            <div class="modal-footer">
                                                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                                <a href="javascript:;" style="display: none;" id="button_update_nilai_level_10_opex" class="btn btn-success button_simpan" onclick="Simpan_level_10_opex('update_nilai_level_10_opex')">Simpan</a>
                                                                                                                <a href="javascript:;" id="button_tambah_level_10_opex" class="btn btn-success button_simpan" onclick="Simpan_level_10_opex('tambah_level_10_opex')">Update</a>
                                                                                                                <a href="javascript:;" id="button_edit_level_10_opex" class="btn btn-success button_simpan" onclick="Simpan_level_10_opex('edit_level_10_opex')">Edit</a>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                                    ...
                                                                                                                    <div class="btn-group">
                                                                                                                        ...
                                                                                                                        <div class="dropdown-menu" role="menu">
                                                                                                                            <?php if ($value_detail_opex_8[$nilai] == null || $value_detail_opex_8[$nilai] == 0) { ?>
                                                                                                                                <?php if ($kondisi_opex_detail_7) { ?>
                                                                                                                                    <a onclick="modal_level_11_opex(<?= $value_detail_opex_8['id_detail_opex_8'] ?>,'tambah_level_11_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                    <a onclick="modal_level_11_opex(<?= $value_detail_opex_8['id_detail_opex_8'] ?>,'edit_level_11_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                    ...
                                                                                                                                    <a onclick="modal_level_11_opex(<?= $value_detail_opex_8['id_detail_opex_8'] ?>,'urutan_level_11_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                                <?php    } else { ?>
                                                                                                                                    ...
                                                                                                                                    <a onclick="modal_level_11_opex(<?= $value_detail_opex_8['id_detail_opex_8'] ?>,'tambah_level_11_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                    <a onclick="modal_level_11_opex(<?= $value_detail_opex_8['id_detail_opex_8'] ?>,'hapus_level_11_opex')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                                    <a onclick="modal_level_11_opex(<?= $value_detail_opex_8['id_detail_opex_8'] ?>,'edit_level_11_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                    <a onclick="modal_level_11_opex(<?= $value_detail_opex_8['id_detail_opex_8'] ?>,'tambah_level_11_opex_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                                    <a onclick="modal_level_11_opex(<?= $value_detail_opex_8['id_detail_opex_8'] ?>,'urutan_level_11_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                                <?php   }  ?>
                                                                                                                    ...
                                                                                                                    <div class="dropdown-menu" role="menu">
                                                                                                                        <?php if ($value_detail_opex_8[$nilai] == null || $value_detail_opex_8[$nilai] == 0) { ?>
                                                                                                                            <?php if ($kondisi_opex_detail_9) { ?>
                                                                                                                                <a onclick="modal_level_11_opex(<?= $value_detail_opex_8['id_detail_opex_8'] ?>,'tambah_level_11_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                <a onclick="modal_level_11_opex(<?= $value_detail_opex_8['id_detail_opex_8'] ?>,'edit_level_11_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                <a onclick="modal_level_11_opex(<?= $value_detail_opex_8['id_detail_opex_8'] ?>,'tambah_level_11_opex_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                                <a onclick="modal_level_11_opex(<?= $value_detail_opex_8['id_detail_opex_8'] ?>,'urutan_level_11_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                            <?php    } else { ?>
                                                                                                                                <a onclick="modal_level_11_opex(<?= $value_detail_opex_8['id_detail_opex_8'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                                <a onclick="modal_level_11_opex(<?= $value_detail_opex_8['id_detail_opex_8'] ?>,'tambah_level_11_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                    ...
                                                                                                    <div class="modal fade" data-backdrop="false" id="form_modal_level_11_opex" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                                        <div class="modal-dialog" role="document">
                                                                                                            <div class="modal-content">
                                                                                                                ...
                                                                                                                <div class="modal-footer">
                                                                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                                    <a href="javascript:;" style="display: none;" id="button_update_nilai_level_11_opex" class="btn btn-success button_simpan" onclick="Simpan_level_11_opex('update_nilai_level_11_opex')">Simpan</a>
                                                                                                                    <a href="javascript:;" id="button_tambah_level_11_opex" class="btn btn-success button_simpan" onclick="Simpan_level_11_opex('tambah_level_11_opex')">Update</a>
                                                                                                                    <a href="javascript:;" id="button_edit_level_11_opex" class="btn btn-success button_simpan" onclick="Simpan_level_11_opex('edit_level_11_opex')">Edit</a>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                                            ...
                                                                                                                            <div class="dropdown-menu" role="menu">
                                                                                                                                <?php if ($value_detail_opex_9[$nilai] == null || $value_detail_opex_9[$nilai] == 0) { ?>
                                                                                                                                    <?php if ($kondisi_opex_detail_10) { ?>
                                                                                                                                        <a onclick="modal_level_12_opex(<?= $value_detail_opex_9['id_detail_opex_9'] ?>,'tambah_level_12_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                        <a onclick="modal_level_12_opex(<?= $value_detail_opex_9['id_detail_opex_9'] ?>,'edit_level_12_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                        ...
                                                                                                                                        <a onclick="modal_level_12_opex(<?= $value_detail_opex_9['id_detail_opex_9'] ?>,'urutan_level_12_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                                    <?php    } else { ?>
                                                                                                                                        ...
                                                                                                                                        <a onclick="modal_level_12_opex(<?= $value_detail_opex_9['id_detail_opex_9'] ?>,'tambah_level_12_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                        <a onclick="modal_level_12_opex(<?= $value_detail_opex_9['id_detail_opex_9'] ?>,'hapus_level_12_opex')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                                        <a onclick="modal_level_12_opex(<?= $value_detail_opex_9['id_detail_opex_9'] ?>,'edit_level_12_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                        <a onclick="modal_level_12_opex(<?= $value_detail_opex_9['id_detail_opex_9'] ?>,'tambah_level_12_opex_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                                        <a onclick="modal_level_12_opex(<?= $value_detail_opex_9['id_detail_opex_9'] ?>,'urutan_level_12_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                                    <?php   }  ?>
                                                                                                                        ...
                                                                                                                        <div class="dropdown-menu" role="menu">
                                                                                                                            <?php if ($value_detail_opex_9[$nilai] == null || $value_detail_opex_9[$nilai] == 0) { ?>
                                                                                                                                <?php if ($kondisi_opex_detail_10) { ?>
                                                                                                                                    <a onclick="modal_level_12_opex(<?= $value_detail_opex_9['id_detail_opex_9'] ?>,'tambah_level_12_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                    <a onclick="modal_level_12_opex(<?= $value_detail_opex_9['id_detail_opex_9'] ?>,'edit_level_12_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                    <a onclick="modal_level_12_opex(<?= $value_detail_opex_9['id_detail_opex_9'] ?>,'tambah_level_12_opex_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                                    <a onclick="modal_level_12_opex(<?= $value_detail_opex_9['id_detail_opex_9'] ?>,'urutan_level_12_opex')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                                <?php    } else { ?>
                                                                                                                                    <a onclick="modal_level_12_opex(<?= $value_detail_opex_9['id_detail_opex_9'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                                    <a onclick="modal_level_12_opex(<?= $value_detail_opex_9['id_detail_opex_9'] ?>,'tambah_level_12_opex')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                        ...
                                                                                                        <div class="modal fade" data-backdrop="false" id="form_modal_level_12_opex" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                                            <div class="modal-dialog" role="document">
                                                                                                                <div class="modal-content">
                                                                                                                    ...
                                                                                                                    <div class="modal-footer">
                                                                                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                                        <a href="javascript:;" style="display: none;" id="button_update_nilai_level_12_opex" class="btn btn-success button_simpan" onclick="Simpan_level_12_opex('update_nilai_level_12_opex')">Simpan</a>
                                                                                                                        <a href="javascript:;" id="button_tambah_level_12_opex" class="btn btn-success button_simpan" onclick="Simpan_level_12_opex('tambah_level_12_opex')">Update</a>
                                                                                                                        <a href="javascript:;" id="button_edit_level_12_opex" class="btn btn-success button_simpan" onclick="Simpan_level_12_opex('edit_level_12_opex')">Edit</a>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
