...
<script>
    ...
    function modal_level_3_opex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_3_opex') {
                    Question_detail_opex(response['row_opex_detail'].nama_uraian, response['row_opex_detail'].id_opex_detail, response['row_opex_detail'].id_opex)
                }
                if (type == 'urutan_level_3_opex') {
                    console.log(response['result_opex']);
                    ...
                    for (i = 0; i < response['result_opex'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_opex(' + response['result_opex'][i].id_opex_detail + ',2.1' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_opex'][i].no_urut + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_detail_opex(ket, id, id_opex) {
        Swal.fire({
...
<script>
    ...
    function modal_level_4_opex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_4_opex') {
                    Question_level_4_opex(response['row_opex_detail_1'].nama_uraian_1_opex, response['row_opex_detail_1'].id_detail_opex_1, response['row_opex_detail_1'].id_opex_detail)
                }
                ...
                if (type == 'urutan_level_4_opex') {
                    ...
                    for (i = 0; i < response['result_detail_opex_1'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_opex(' + response['result_detail_opex_1'][i].id_detail_opex_1 + ',2.2' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_opex_1'][i].no_urut_1_opex + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_4_opex(ket, id, id_opex_detail) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_5_opex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_5_opex') {
                    Question_level_5_opex(response['row_opex_detail_2'].nama_uraian_2_opex, response['row_opex_detail_2'].id_detail_opex_2, response['row_opex_detail_2'].id_detail_opex_1)
                }
                // _2
                if (type == 'urutan_level_5_opex') {
                    modal_opex_urutan.modal('show')
                    ...
                    for (i = 0; i < response['result_detail_opex_2'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_opex(' + response['result_detail_opex_2'][i].id_detail_opex_2 + ',2.3' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_opex_2'][i].no_urut_2_opex + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_5_opex(ket, id, id_detail_opex_1) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_6_opex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_6_opex') {
                    Question_level_6_opex(response['row_opex_detail_3'].nama_uraian_3_opex, response['row_opex_detail_3'].id_detail_opex_3, response['row_opex_detail_3'].id_detail_opex_2)
                }
                // _3
                if (type == 'urutan_level_6_opex') {
                    modal_opex_urutan.modal('show')
                    ...
                    for (i = 0; i < response['result_detail_opex_3'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_opex(' + response['result_detail_opex_3'][i].id_detail_opex_3 + ',2.4' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_opex_3'][i].no_urut_3_opex + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_6_opex(ket, id, id_detail_opex_2) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_7_opex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_7_opex') {
                    Question_level_7_opex(response['row_opex_detail_4'].nama_uraian_4_opex, response['row_opex_detail_4'].id_detail_opex_4, response['row_opex_detail_4'].id_detail_opex_3)
                }
                ...
                if (type == 'urutan_level_7_opex') {
                    ...
                    for (i = 0; i < response['result_detail_opex_4'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_opex(' + response['result_detail_opex_4'][i].id_detail_opex_4 + ',2.5' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_opex_4'][i].no_urut_4_opex + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_7_opex(ket, id, id_detail_opex_3) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_8_opex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_8_opex') {
                    Question_level_8_opex(response['row_opex_detail_5'].nama_uraian_5_opex, response['row_opex_detail_5'].id_detail_opex_5, response['row_opex_detail_5'].id_detail_opex_4)
                }
                ...
                if (type == 'urutan_level_8_opex') {
                    ...
                    for (i = 0; i < response['result_detail_opex_5'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_opex(' + response['result_detail_opex_5'][i].id_detail_opex_5 + ',2.6' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_opex_5'][i].no_urut_5_opex + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_8_opex(ket, id, id_detail_opex_4) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_9_opex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_9_opex') {
                    Question_level_9_opex(response['row_opex_detail_6'].nama_uraian_6_opex, response['row_opex_detail_6'].id_detail_opex_6, response['row_opex_detail_6'].id_detail_opex_5)
                }
                ...
                if (type == 'urutan_level_9_opex') {
                    ...
                    for (i = 0; i < response['result_detail_opex_6'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_opex(' + response['result_detail_opex_6'][i].id_detail_opex_6 + ',2.7' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_opex_6'][i].no_urut_6_opex + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_9_opex(ket, id, id_detail_opex_5) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_10_opex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_10_opex') {
                    Question_level_10_opex(response['row_opex_detail_7'].nama_uraian_7_opex, response['row_opex_detail_7'].id_detail_opex_7, response['row_opex_detail_7'].id_detail_opex_6)
                }
                ...
                if (type == 'urutan_level_10_opex') {
                    ...
                    for (i = 0; i < response['result_detail_opex_7'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_opex(' + response['result_detail_opex_7'][i].id_detail_opex_7 + ',2.8' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_opex_7'][i].no_urut_7_opex + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_10_opex(ket, id, id_detail_opex_6) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_11_opex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_11_opex') {
                    Question_level_11_opex(response['row_opex_detail_8'].nama_uraian_8_opex, response['row_opex_detail_8'].id_detail_opex_8, response['row_opex_detail_8'].id_detail_opex_7)
                }
                // _11
                if (type == 'urutan_level_11_opex') {
                    modal_opex_urutan.modal('show')
                    ...
                    for (i = 0; i < response['result_detail_opex_8'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_opex(' + response['result_detail_opex_8'][i].id_detail_opex_8 + ',2.9' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_opex_8'][i].no_urut_8_opex + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_11_opex(ket, id, id_detail_opex_7) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_12_opex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_12_opex') {
                    Question_level_12_opex(response['row_opex_detail_9'].nama_uraian_9_opex, response['row_opex_detail_9'].id_detail_opex_9, response['row_opex_detail_9'].id_detail_opex_8)
                }
                ...
                if (type == 'urutan_level_12_opex') {
                    ...
                    for (i = 0; i < response['result_detail_opex_9'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_opex(' + response['result_detail_opex_9'][i].id_detail_opex_9 + ',2.10' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_opex_9'][i].no_urut_9_opex + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_12_opex(ket, id, id_detail_opex_8) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
