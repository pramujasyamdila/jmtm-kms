...
<script>
    ...
    function modal_level_3_capex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_3_capex') {
                    Question_detail_capex(response['row_capex_detail'].nama_uraian, response['row_capex_detail'].id_capex_detail, response['row_capex_detail'].id_capex)
                }
    ...
    function Question_detail_capex(ket, id, id_capex) {
        Swal.fire({
...
<script>
    ...
    function modal_level_4_capex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_4_capex') {
                    Question_level_4_capex(response['row_capex_detail_1'].nama_uraian_1_capex, response['row_capex_detail_1'].id_detail_capex_1, response['row_capex_detail_1'].id_capex_detail)
                }
    ...
    function Question_level_4_capex(ket, id, id_capex_detail) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_5_capex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_5_capex') {
                    Question_level_5_capex(response['row_capex_detail_2'].nama_uraian_2_capex, response['row_capex_detail_2'].id_detail_capex_2, response['row_capex_detail_2'].id_detail_capex_1)
                }
                // _2
                if (type == 'urutan_level_5_capex') {
                    modal_capex_urutan.modal('show')
    ...
    function Question_level_5_capex(ket, id, id_detail_capex_1) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_6_capex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_6_capex') {
                    Question_level_6_capex(response['row_capex_detail_3'].nama_uraian_3_capex, response['row_capex_detail_3'].id_detail_capex_3, response['row_capex_detail_3'].id_detail_capex_2)
                }
                // _3
                if (type == 'urutan_level_6_capex') {
                    modal_capex_urutan.modal('show')
    ...
    function Question_level_6_capex(ket, id, id_detail_capex_2) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_7_capex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_7_capex') {
                    Question_level_7_capex(response['row_capex_detail_4'].nama_uraian_4_capex, response['row_capex_detail_4'].id_detail_capex_4, response['row_capex_detail_4'].id_detail_capex_3)
                }
    ...
    function Question_level_7_capex(ket, id, id_detail_capex_3) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_8_capex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_8_capex') {
                    Question_level_8_capex(response['row_capex_detail_5'].nama_uraian_5_capex, response['row_capex_detail_5'].id_detail_capex_5, response['row_capex_detail_5'].id_detail_capex_4)
                }
    ...
    function Question_level_8_capex(ket, id, id_detail_capex_4) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_9_capex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_9_capex') {
                    Question_level_9_capex(response['row_capex_detail_6'].nama_uraian_6_capex, response['row_capex_detail_6'].id_detail_capex_6, response['row_capex_detail_6'].id_detail_capex_5)
                }
    ...
    function Question_level_9_capex(ket, id, id_detail_capex_5) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_10_capex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_10_capex') {
                    Question_level_10_capex(response['row_capex_detail_7'].nama_uraian_7_capex, response['row_capex_detail_7'].id_detail_capex_7, response['row_capex_detail_7'].id_detail_capex_6)
                }
    ...
    function Question_level_10_capex(ket, id, id_detail_capex_6) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_11_capex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_11_capex') {
                    Question_level_11_capex(response['row_capex_detail_8'].nama_uraian_8_capex, response['row_capex_detail_8'].id_detail_capex_8, response['row_capex_detail_8'].id_detail_capex_7)
                }
                // _11
                if (type == 'urutan_level_11_capex') {
                    modal_capex_urutan.modal('show')
    ...
    function Question_level_11_capex(ket, id, id_detail_capex_7) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_12_capex(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_12_capex') {
                    Question_level_12_capex(response['row_capex_detail_9'].nama_uraian_9_capex, response['row_capex_detail_9'].id_detail_capex_9, response['row_capex_detail_9'].id_detail_capex_8)
                }
    ...
    function Question_level_12_capex(ket, id, id_detail_capex_8) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
