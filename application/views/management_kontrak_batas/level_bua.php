...
<script>
    ...
    function modal_level_3_bua(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_3_bua') {
                    Question_detail_bua(response['row_bua_detail'].nama_uraian, response['row_bua_detail'].id_bua_detail, response['row_bua_detail'].id_bua)
                }
                ...
                if (type == 'urutan_level_3_bua') {
                    ...
                    for (i = 0; i < response['result_bua'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_bua(' + response['result_bua'][i].id_bua_detail + ',3.1' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_bua'][i].no_urut + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_detail_bua(ket, id, id_bua) {
        Swal.fire({
...
<script>
    ...
    function modal_level_4_bua(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_4_bua') {
                    Question_level_4_bua(response['row_bua_detail_1'].nama_uraian_1_bua, response['row_bua_detail_1'].id_detail_bua_1, response['row_bua_detail_1'].id_bua_detail)
                }
                ...
                if (type == 'urutan_level_4_bua') {
                    ...
                    for (i = 0; i < response['result_detail_bua_1'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_bua(' + response['result_detail_bua_1'][i].id_detail_bua_1 + ',3.2' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_bua_1'][i].no_urut_1_bua + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_4_bua(ket, id, id_bua_detail) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_5_bua(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_5_bua') {
                    Question_level_5_bua(response['row_bua_detail_2'].nama_uraian_2_bua, response['row_bua_detail_2'].id_detail_bua_2, response['row_bua_detail_2'].id_detail_bua_1)
                }
                // _2
                if (type == 'urutan_level_5_bua') {
                    modal_bua_urutan.modal('show')
                    ...
                    for (i = 0; i < response['result_detail_bua_2'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_bua(' + response['result_detail_bua_2'][i].id_detail_bua_2 + ',3.3' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_bua_2'][i].no_urut_2_bua + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_5_bua(ket, id, id_detail_bua_1) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_6_bua(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_6_bua') {
                    Question_level_6_bua(response['row_bua_detail_3'].nama_uraian_3_bua, response['row_bua_detail_3'].id_detail_bua_3, response['row_bua_detail_3'].id_detail_bua_2)
                }
                // _3
                if (type == 'urutan_level_6_bua') {
                    modal_bua_urutan.modal('show')
                    ...
                    for (i = 0; i < response['result_detail_bua_3'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_bua(' + response['result_detail_bua_3'][i].id_detail_bua_3 + ',3.4' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_bua_3'][i].no_urut_3_bua + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_6_bua(ket, id, id_detail_bua_2) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_7_bua(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_7_bua') {
                    Question_level_7_bua(response['row_bua_detail_4'].nama_uraian_4_bua, response['row_bua_detail_4'].id_detail_bua_4, response['row_bua_detail_4'].id_detail_bua_3)
                }
                ...
                if (type == 'urutan_level_7_bua') {
                    ...
                    for (i = 0; i < response['result_detail_bua_4'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_bua(' + response['result_detail_bua_4'][i].id_detail_bua_4 + ',3.5' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_bua_4'][i].no_urut_4_bua + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_7_bua(ket, id, id_detail_bua_3) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_8_bua(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_8_bua') {
                    Question_level_8_bua(response['row_bua_detail_5'].nama_uraian_5_bua, response['row_bua_detail_5'].id_detail_bua_5, response['row_bua_detail_5'].id_detail_bua_4)
                }
                ...
                if (type == 'urutan_level_8_bua') {
                    ...
                    for (i = 0; i < response['result_detail_bua_5'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_bua(' + response['result_detail_bua_5'][i].id_detail_bua_5 + ',3.6' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_bua_5'][i].no_urut_5_bua + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_8_bua(ket, id, id_detail_bua_4) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_9_bua(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_9_bua') {
                    Question_level_9_bua(response['row_bua_detail_6'].nama_uraian_6_bua, response['row_bua_detail_6'].id_detail_bua_6, response['row_bua_detail_6'].id_detail_bua_5)
                }
                ...
                if (type == 'urutan_level_9_bua') {
                    ...
                    for (i = 0; i < response['result_detail_bua_6'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_bua(' + response['result_detail_bua_6'][i].id_detail_bua_6 + ',3.7' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_bua_6'][i].no_urut_6_bua + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_9_bua(ket, id, id_detail_bua_5) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_10_bua(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_10_bua') {
                    Question_level_10_bua(response['row_bua_detail_7'].nama_uraian_7_bua, response['row_bua_detail_7'].id_detail_bua_7, response['row_bua_detail_7'].id_detail_bua_6)
                }
                ...
                if (type == 'urutan_level_10_bua') {
                    ...
                    for (i = 0; i < response['result_detail_bua_7'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_bua(' + response['result_detail_bua_7'][i].id_detail_bua_7 + ',3.8' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_bua_7'][i].no_urut_7_bua + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_10_bua(ket, id, id_detail_bua_6) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_11_bua(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_11_bua') {
                    Question_level_11_bua(response['row_bua_detail_8'].nama_uraian_8_bua, response['row_bua_detail_8'].id_detail_bua_8, response['row_bua_detail_8'].id_detail_bua_7)
                }
                // _11
                if (type == 'urutan_level_11_bua') {
                    modal_bua_urutan.modal('show')
                    ...
                    for (i = 0; i < response['result_detail_bua_8'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_bua(' + response['result_detail_bua_8'][i].id_detail_bua_8 + ',3.9' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_bua_8'][i].no_urut_8_bua + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_11_bua(ket, id, id_detail_bua_7) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_12_bua(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_12_bua') {
                    Question_level_12_bua(response['row_bua_detail_9'].nama_uraian_9_bua, response['row_bua_detail_9'].id_detail_bua_9, response['row_bua_detail_9'].id_detail_bua_8)
                }
                ...
                if (type == 'urutan_level_12_bua') {
                    ...
                    for (i = 0; i < response['result_detail_bua_9'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_bua(' + response['result_detail_bua_9'][i].id_detail_bua_9 + ',3.10' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_bua_9'][i].no_urut_9_bua + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_12_bua(ket, id, id_detail_bua_8) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
