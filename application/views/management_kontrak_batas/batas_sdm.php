                                                                    ...
                                                                    <tr class="bg-success text-white" style="font-size:12px;font-weight:700">
                                                                        ...
                                                                        <?php if ($adendum_result) { ?>
                                                                            <?php foreach ($adendum_result as $key => $value) { ?>
                                                                                ...
                                                                                ?>
                                                                                <td class="tg-0lax text-white"> <?= "Rp " . number_format($value_sdm[$nilai], 2, ',', '.') ?>
                                                                                </td>
                                                                                <td class="tg-0lax">
                                                                                    <div class="btn-group">
                                                                                        ...
                                                                                        <div class="dropdown-menu" role="menu">
                                                                                            <?php if ($value_sdm[$nilai] == null || $value_sdm[$nilai] == 0) { ?>
                                                                                                <?php if ($kondisi_detail_sdm) { ?>
                                                                                                    <a onclick="modal_level_2_sdm(<?= $value_sdm['id_sdm'] ?>,'tambah_level_2_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                ...
                                                                                <div class="btn-group">
                                                                                    ...
                                                                                    <div class="dropdown-menu" role="menu">
                                                                                        <?php if ($value_sdm[$nilai] == null || $value_sdm[$nilai] == 0) { ?>
                                                                                            <?php if ($kondisi_detail_sdm) { ?>
                                                                                                <a onclick="modal_level_2_sdm(<?= $value_sdm['id_sdm'] ?>,'tambah_level_2_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                <a onclick="modal_level_2_sdm(<?= $value_sdm['id_sdm'] ?>,'tambah_level_2_sdm_excel',null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                            <?php    } else { ?>
                                                                                                <a onclick="modal_level_2_sdm(<?= $value_sdm['id_sdm'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                <a onclick="modal_level_2_sdm(<?= $value_sdm['id_sdm'] ?>,'tambah_level_2_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                <a onclick="modal_level_2_sdm(<?= $value_sdm['id_sdm'] ?>,'tambah_level_2_sdm_excel',null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                            ...
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-footer">
                                                                                        ...
                                                                                        <a href="javascript:;" style="display: none;" id="button_update_nilai_level_2_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_2_sdm(<?= $value_sdm['id_sdm'] ?>,'update_nilai_level_2_sdm')">Simpan</a>
                                                                                        <a href="javascript:;" id="button_tambah_level_2_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_2_sdm(<?= $value_sdm['id_sdm'] ?>,'tambah_level_2_sdm')">Update</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                        ...
                                                                                        <div class="dropdown-menu" role="menu">
                                                                                            <?php if ($value_detail_sdm[$nilai] == null || $value_detail_sdm[$nilai] == 0) { ?>
                                                                                                <?php if ($kondisi_sdm_detail_1) { ?>
                                                                                                    <a onclick="modal_level_3_sdm(<?= $value_detail_sdm['id_sdm_detail'] ?>,'tambah_level_3_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                    <a onclick="modal_level_3_sdm(<?= $value_detail_sdm['id_sdm_detail'] ?>,'edit_level_3_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                    <!-- UBAH urutan -->
                                                                                                    ...
                                                                                                    <a onclick="modal_level_3_sdm(<?= $value_detail_sdm['id_sdm_detail'] ?>,'urutan_level_3_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                <?php    } else { ?>
                                                                                                    ...
                                                                                                    <a onclick="modal_level_3_sdm(<?= $value_detail_sdm['id_sdm_detail'] ?>,'tambah_level_3_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                    <a onclick="modal_level_3_sdm(<?= $value_detail_sdm['id_sdm_detail'] ?>,'hapus_level_3_sdm')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                    <a onclick="modal_level_3_sdm(<?= $value_detail_sdm['id_sdm_detail'] ?>,'edit_level_3_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                    <a onclick="modal_level_3_sdm(<?= $value_detail_sdm['id_sdm_detail'] ?>,'tambah_level_3_sdm_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                    <!-- UBAH urutan -->
                                                                                                    <a onclick="modal_level_3_sdm(<?= $value_detail_sdm['id_sdm_detail'] ?>,'urutan_level_3_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                            ...
                                                                                            <?php } else { ?>
                                                                                                <?php if ($kondisi_sdm_detail_1) { ?>
                                                                                                    <a onclick="modal_level_3_sdm(<?= $value_detail_sdm['id_sdm_detail'] ?>,'tambah_level_3_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                    <a onclick="modal_level_3_sdm(<?= $value_detail_sdm['id_sdm_detail'] ?>,'edit_level_3_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                    <a onclick="modal_level_3_sdm(<?= $value_detail_sdm['id_sdm_detail'] ?>,'tambah_level_3_sdm_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                    <!-- UBAH urutan -->
                                                                                                    <a onclick="modal_level_3_sdm(<?= $value_detail_sdm['id_sdm_detail'] ?>,'urutan_level_3_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                <?php    } else { ?>
                                                                                                    <a onclick="modal_level_3_sdm(<?= $value_detail_sdm['id_sdm_detail'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                    ...
                                                                    <div class="modal fade" data-backdrop="false" id="form_modal_level_3_sdm" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                    <a href="javascript:;" style="display: none;" id="button_update_nilai_level_3_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_3_sdm('update_nilai_level_3_sdm')">Simpan</a>
                                                                                    <a href="javascript:;" id="button_tambah_level_3_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_3_sdm('tambah_level_3_sdm')">Update</a>
                                                                                    <a href="javascript:;" id="button_edit_level_3_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_3_sdm('edit_level_3_sdm')">Edit</a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <?php
                                                                                        ...
                                                                                        <div class="btn-group">
                                                                                            ...
                                                                                            <div class="dropdown-menu" role="menu">
                                                                                                <?php if ($value_detail_sdm_1[$nilai] == null || $value_detail_sdm_1[$nilai] == 0) { ?>
                                                                                                    <?php if ($kondisi_sdm_detail_1) { ?>
                                                                                                        <a onclick="modal_level_4_sdm(<?= $value_detail_sdm_1['id_detail_sdm_1'] ?>,'tambah_level_4_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                        <a onclick="modal_level_4_sdm(<?= $value_detail_sdm_1['id_detail_sdm_1'] ?>,'edit_level_4_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                        ...
                                                                                                        <a onclick="modal_level_4_sdm(<?= $value_detail_sdm_1['id_detail_sdm_1'] ?>,'urutan_level_4_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                    <?php    } else { ?>
                                                                                                        ...
                                                                                                        <a onclick="modal_level_4_sdm(<?= $value_detail_sdm_1['id_detail_sdm_1'] ?>,'tambah_level_4_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                        <a onclick="modal_level_4_sdm(<?= $value_detail_sdm_1['id_detail_sdm_1'] ?>,'hapus_level_4_sdm')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                        <a onclick="modal_level_4_sdm(<?= $value_detail_sdm_1['id_detail_sdm_1'] ?>,'edit_level_4_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                        <a onclick="modal_level_4_sdm(<?= $value_detail_sdm_1['id_detail_sdm_1'] ?>,'tambah_level_4_sdm_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                        <a onclick="modal_level_4_sdm(<?= $value_detail_sdm_1['id_detail_sdm_1'] ?>,'urutan_level_4_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                    <?php   }  ?>
                                                                                        ...
                                                                                        <div class="dropdown-menu" role="menu">
                                                                                            <?php if ($value_detail_sdm_1[$nilai] == null || $value_detail_sdm_1[$nilai] == 0) { ?>
                                                                                                <?php if ($kondisi_sdm_detail_1) { ?>
                                                                                                    <a onclick="modal_level_4_sdm(<?= $value_detail_sdm_1['id_detail_sdm_1'] ?>,'tambah_level_4_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                    <a onclick="modal_level_4_sdm(<?= $value_detail_sdm_1['id_detail_sdm_1'] ?>,'edit_level_4_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                    <a onclick="modal_level_4_sdm(<?= $value_detail_sdm_1['id_detail_sdm_1'] ?>,'tambah_level_4_sdm_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                    <a onclick="modal_level_4_sdm(<?= $value_detail_sdm_1['id_detail_sdm_1'] ?>,'urutan_level_4_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                <?php    } else { ?>
                                                                                                    <a onclick="modal_level_4_sdm(<?= $value_detail_sdm_1['id_detail_sdm_1'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                    <a onclick="modal_level_4_sdm(<?= $value_detail_sdm_1['id_detail_sdm_1'] ?>,'tambah_level_4_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                        ...
                                                                        <div class="modal fade" data-backdrop="false" id="form_modal_level_4_sdm" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-footer">
                                                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                        <a href="javascript:;" style="display: none;" id="button_update_nilai_level_4_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_4_sdm('update_nilai_level_4_sdm')">Simpan</a>
                                                                                        <a href="javascript:;" id="button_tambah_level_4_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_4_sdm('tambah_level_4_sdm')">Update</a>
                                                                                        <a href="javascript:;" id="button_edit_level_4_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_4_sdm('edit_level_4_sdm')">Edit</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            <tr class="text-danger" style="font-size:11px;font-weight: 400;">
                                                                                ...
                                                                                <td class="tg-0lax" style="white-space: nowrap; width: 300px;overflow: hidden;text-overflow: ellipsis;" title="<?= $value_detail_sdm_2['nama_uraian_2_sdm'] ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<?= $value_detail_sdm_2['nama_uraian_2_sdm'] ?></td>
                                                                                <?php if ($adendum_result) { ?>
                                                                                    <?php foreach ($adendum_result as $key => $value) { ?>
                                                                                        <?php
                                                                                            if ($value['no_adendum'] == 1) {
                                                                                                ...
                                                                                                <div class="dropdown-menu" role="menu">
                                                                                                    <?php if ($value_detail_sdm_2[$nilai] == null || $value_detail_sdm_2[$nilai] == 0) { ?>
                                                                                                        <?php if ($kondisi_sdm_detail_2) { ?>
                                                                                                            <a onclick="modal_level_5_sdm(<?= $value_detail_sdm_2['id_detail_sdm_2'] ?>,'tambah_level_5_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                            <a onclick="modal_level_5_sdm(<?= $value_detail_sdm_2['id_detail_sdm_2'] ?>,'edit_level_5_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                            ...
                                                                                                            <a onclick="modal_level_5_sdm(<?= $value_detail_sdm_2['id_detail_sdm_2'] ?>,'urutan_level_5_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                        <?php    } else { ?>
                                                                                                            ...
                                                                                                            <a onclick="modal_level_5_sdm(<?= $value_detail_sdm_2['id_detail_sdm_2'] ?>,'tambah_level_5_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                            <a onclick="modal_level_5_sdm(<?= $value_detail_sdm_2['id_detail_sdm_2'] ?>,'hapus_level_5_sdm')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                            <a onclick="modal_level_5_sdm(<?= $value_detail_sdm_2['id_detail_sdm_2'] ?>,'edit_level_5_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                            <a onclick="modal_level_5_sdm(<?= $value_detail_sdm_2['id_detail_sdm_2'] ?>,'tambah_level_5_sdm_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                            <a onclick="modal_level_5_sdm(<?= $value_detail_sdm_2['id_detail_sdm_2'] ?>,'urutan_level_5_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                        <?php   }  ?>
                                                                                            ...
                                                                                            <div class="dropdown-menu" role="menu">
                                                                                                <?php if ($value_detail_sdm_2[$nilai] == null || $value_detail_sdm_2[$nilai] == 0) { ?>
                                                                                                    <?php if ($kondisi_sdm_detail_2) { ?>
                                                                                                        <a onclick="modal_level_5_sdm(<?= $value_detail_sdm_2['id_detail_sdm_2'] ?>,'tambah_level_5_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                        <a onclick="modal_level_5_sdm(<?= $value_detail_sdm_2['id_detail_sdm_2'] ?>,'edit_level_5_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                        <a onclick="modal_level_5_sdm(<?= $value_detail_sdm_2['id_detail_sdm_2'] ?>,'tambah_level_5_sdm_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                        <a onclick="modal_level_5_sdm(<?= $value_detail_sdm_2['id_detail_sdm_2'] ?>,'urutan_level_5_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                    <?php    } else { ?>
                                                                                                        <a onclick="modal_level_5_sdm(<?= $value_detail_sdm_2['id_detail_sdm_2'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                        <a onclick="modal_level_5_sdm(<?= $value_detail_sdm_2['id_detail_sdm_2'] ?>,'tambah_level_5_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                            ...
                                                                            <div class="modal fade" data-backdrop="false" id="form_modal_level_5_sdm" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                <div class="modal-dialog" role="document">
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <div class="modal-footer">
                                                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                            <a href="javascript:;" style="display: none;" id="button_update_nilai_level_5_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_5_sdm('update_nilai_level_5_sdm')">Simpan</a>
                                                                                            <a href="javascript:;" id="button_tambah_level_5_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_5_sdm('tambah_level_5_sdm')">Update</a>
                                                                                            <a href="javascript:;" id="button_edit_level_5_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_5_sdm('edit_level_5_sdm')">Edit</a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                <tr class="text-success" style="font-size:11px;font-weight: 350;">
                                                                                    ...
                                                                                    <td class="tg-0lax">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<?= $value_detail_sdm_3['nama_uraian_3_sdm'] ?></td>
                                                                                                    ...
                                                                                                    <div class="dropdown-menu" role="menu">
                                                                                                        <?php if ($value_detail_sdm_3[$nilai] == null || $value_detail_sdm_3[$nilai] == 0) { ?>
                                                                                                            <?php if ($kondisi_sdm_detail_4) { ?>
                                                                                                                <a onclick="modal_level_6_sdm(<?= $value_detail_sdm_3['id_detail_sdm_3'] ?>,'tambah_level_6_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                <a onclick="modal_level_6_sdm(<?= $value_detail_sdm_3['id_detail_sdm_3'] ?>,'edit_level_6_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                ...
                                                                                                                <a onclick="modal_level_6_sdm(<?= $value_detail_sdm_3['id_detail_sdm_3'] ?>,'urutan_level_6_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                            <?php    } else { ?>
                                                                                                                ...
                                                                                                                <a onclick="modal_level_6_sdm(<?= $value_detail_sdm_3['id_detail_sdm_3'] ?>,'tambah_level_6_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                <a onclick="modal_level_6_sdm(<?= $value_detail_sdm_3['id_detail_sdm_3'] ?>,'hapus_level_6_sdm')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                <a onclick="modal_level_6_sdm(<?= $value_detail_sdm_3['id_detail_sdm_3'] ?>,'edit_level_6_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                <a onclick="modal_level_6_sdm(<?= $value_detail_sdm_3['id_detail_sdm_3'] ?>,'tambah_level_6_sdm_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                ...
                                                                                                <div class="dropdown-menu" role="menu">
                                                                                                    <?php if ($value_detail_sdm_3[$nilai] == null || $value_detail_sdm_3[$nilai] == 0) { ?>
                                                                                                        <?php if ($kondisi_sdm_detail_4) { ?>
                                                                                                            <a onclick="modal_level_6_sdm(<?= $value_detail_sdm_3['id_detail_sdm_3'] ?>,'tambah_level_6_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                            <a onclick="modal_level_6_sdm(<?= $value_detail_sdm_3['id_detail_sdm_3'] ?>,'edit_level_6_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                            <a onclick="modal_level_6_sdm(<?= $value_detail_sdm_3['id_detail_sdm_3'] ?>,'tambah_level_6_sdm_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                            <a onclick="modal_level_6_sdm(<?= $value_detail_sdm_3['id_detail_sdm_3'] ?>,'urutan_level_6_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                        <?php    } else { ?>
                                                                                                            <a onclick="modal_level_6_sdm(<?= $value_detail_sdm_3['id_detail_sdm_3'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                            <a onclick="modal_level_6_sdm(<?= $value_detail_sdm_3['id_detail_sdm_3'] ?>,'tambah_level_6_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                ...
                                                                                <div class="modal fade" data-backdrop="false" id="form_modal_level_6_sdm" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                    <div class="modal-dialog" role="document">
                                                                                        <div class="modal-content">
                                                                                            ...
                                                                                            <div class="modal-footer">
                                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                <a href="javascript:;" style="display: none;" id="button_update_nilai_level_6_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_6_sdm('update_nilai_level_6_sdm')">Simpan</a>
                                                                                                <a href="javascript:;" id="button_tambah_level_6_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_6_sdm('tambah_level_6_sdm')">Update</a>
                                                                                                <a href="javascript:;" id="button_edit_level_6_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_6_sdm('edit_level_6_sdm')">Edit</a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <?php
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="tg-0lax">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<?= $value_detail_sdm_4['nama_uraian_4_sdm'] ?></td>
                                                                                        <?php if ($adendum_result) { ?>
                                                                                            <?php foreach ($adendum_result as $key => $value) { ?>
                                                                                                <?php
                                                                                                    if ($value['no_adendum'] == 1) {
                                                                                                        ...
                                                                                                        <div class="dropdown-menu" role="menu">
                                                                                                            <?php if ($value_detail_sdm_4[$nilai] == null || $value_detail_sdm_4[$nilai] == 0) { ?>
                                                                                                                <?php if ($kondisi_sdm_detail_5) { ?>
                                                                                                                    <a onclick="modal_level_7_sdm(<?= $value_detail_sdm_4['id_detail_sdm_4'] ?>,'tambah_level_7_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                    <a onclick="modal_level_7_sdm(<?= $value_detail_sdm_4['id_detail_sdm_4'] ?>,'edit_level_7_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                    <a onclick="modal_level_7_sdm(<?= $value_detail_sdm_4['id_detail_sdm_4'] ?>,'urutan_level_7_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                <?php    } else { ?>
                                                                                                                    ...
                                                                                                                    <a onclick="modal_level_7_sdm(<?= $value_detail_sdm_4['id_detail_sdm_4'] ?>,'tambah_level_7_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                    <a onclick="modal_level_7_sdm(<?= $value_detail_sdm_4['id_detail_sdm_4'] ?>,'hapus_level_7_sdm')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                    <a onclick="modal_level_7_sdm(<?= $value_detail_sdm_4['id_detail_sdm_4'] ?>,'edit_level_7_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                    ...
                                                                                                    <div class="dropdown-menu" role="menu">
                                                                                                        <?php if ($value_detail_sdm_4[$nilai] == null || $value_detail_sdm_4[$nilai] == 0) { ?>
                                                                                                            <?php if ($kondisi_sdm_detail_5) { ?>
                                                                                                                <a onclick="modal_level_7_sdm(<?= $value_detail_sdm_4['id_detail_sdm_4'] ?>,'tambah_level_7_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                <a onclick="modal_level_7_sdm(<?= $value_detail_sdm_4['id_detail_sdm_4'] ?>,'edit_level_7_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                <a onclick="modal_level_7_sdm(<?= $value_detail_sdm_4['id_detail_sdm_4'] ?>,'tambah_level_7_sdm_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                <a onclick="modal_level_7_sdm(<?= $value_detail_sdm_4['id_detail_sdm_4'] ?>,'urutan_level_7_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                            <?php    } else { ?>
                                                                                                                <a onclick="modal_level_7_sdm(<?= $value_detail_sdm_4['id_detail_sdm_4'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                <a onclick="modal_level_7_sdm(<?= $value_detail_sdm_4['id_detail_sdm_4'] ?>,'tambah_level_7_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                    ...
                                                                                    <div class="modal fade" data-backdrop="false" id="form_modal_level_7_sdm" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                        <div class="modal-dialog" role="document">
                                                                                            <div class="modal-content">
                                                                                                ...
                                                                                                <div class="modal-footer">
                                                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                    <a href="javascript:;" style="display: none;" id="button_update_nilai_level_7_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_7_sdm('update_nilai_level_7_sdm')">Simpan</a>
                                                                                                    <a href="javascript:;" id="button_tambah_level_7_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_7_sdm('tambah_level_7_sdm')">Update</a>
                                                                                                    <a href="javascript:;" id="button_edit_level_7_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_7_sdm('edit_level_7_sdm')">Edit</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                                            ...
                                                                                                            <div class="dropdown-menu" role="menu">
                                                                                                                <?php if ($value_detail_sdm_5[$nilai] == null || $value_detail_sdm_5[$nilai] == 0) { ?>
                                                                                                                    <?php if ($kondisi_sdm_detail_6) { ?>
                                                                                                                        <a onclick="modal_level_8_sdm(<?= $value_detail_sdm_5['id_detail_sdm_5'] ?>,'tambah_level_8_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                        <a onclick="modal_level_8_sdm(<?= $value_detail_sdm_5['id_detail_sdm_5'] ?>,'edit_level_8_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                        ...
                                                                                                                        <a onclick="modal_level_8_sdm(<?= $value_detail_sdm_5['id_detail_sdm_5'] ?>,'urutan_level_8_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                    <?php    } else { ?>
                                                                                                                        ...
                                                                                                                        <a onclick="modal_level_8_sdm(<?= $value_detail_sdm_5['id_detail_sdm_5'] ?>,'tambah_level_8_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                        <a onclick="modal_level_8_sdm(<?= $value_detail_sdm_5['id_detail_sdm_5'] ?>,'hapus_level_8_sdm')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                        <a onclick="modal_level_8_sdm(<?= $value_detail_sdm_5['id_detail_sdm_5'] ?>,'edit_level_8_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                        <a onclick="modal_level_8_sdm(<?= $value_detail_sdm_5['id_detail_sdm_5'] ?>,'tambah_level_8_sdm_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                        <a onclick="modal_level_8_sdm(<?= $value_detail_sdm_5['id_detail_sdm_5'] ?>,'urutan_level_8_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                    <?php   }  ?>
                                                                                                        ...
                                                                                                        <div class="dropdown-menu" role="menu">
                                                                                                            <?php if ($value_detail_sdm_5[$nilai] == null || $value_detail_sdm_5[$nilai] == 0) { ?>
                                                                                                                <?php if ($kondisi_sdm_detail_6) { ?>
                                                                                                                    <a onclick="modal_level_8_sdm(<?= $value_detail_sdm_5['id_detail_sdm_5'] ?>,'tambah_level_8_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                    <a onclick="modal_level_8_sdm(<?= $value_detail_sdm_5['id_detail_sdm_5'] ?>,'edit_level_8_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                    <a onclick="modal_level_8_sdm(<?= $value_detail_sdm_5['id_detail_sdm_5'] ?>,'tambah_level_8_sdm_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                    <a onclick="modal_level_8_sdm(<?= $value_detail_sdm_5['id_detail_sdm_5'] ?>,'urutan_level_8_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                <?php    } else { ?>
                                                                                                                    <a onclick="modal_level_8_sdm(<?= $value_detail_sdm_5['id_detail_sdm_5'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                    <a onclick="modal_level_8_sdm(<?= $value_detail_sdm_5['id_detail_sdm_5'] ?>,'tambah_level_8_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                        ...
                                                                                        <div class="modal fade" data-backdrop="false" id="form_modal_level_8_sdm" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                            <div class="modal-dialog" role="document">
                                                                                                <div class="modal-content">
                                                                                                    ...
                                                                                                    <div class="modal-footer">
                                                                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                        <a href="javascript:;" style="display: none;" id="button_update_nilai_level_8_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_8_sdm('update_nilai_level_8_sdm')">Simpan</a>
                                                                                                        <a href="javascript:;" id="button_tambah_level_8_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_8_sdm('tambah_level_8_sdm')">Update</a>
                                                                                                        <a href="javascript:;" id="button_edit_level_8_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_8_sdm('edit_level_8_sdm')">Edit</a>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                                                ...
                                                                                                                <div class="dropdown-menu" role="menu">
                                                                                                                    <?php if ($value_detail_sdm_6[$nilai] == null || $value_detail_sdm_6[$nilai] == 0) { ?>
                                                                                                                        <?php if ($kondisi_sdm_detail_7) { ?>
                                                                                                                            <a onclick="modal_level_9_sdm(<?= $value_detail_sdm_6['id_detail_sdm_6'] ?>,'tambah_level_9_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                            <a onclick="modal_level_9_sdm(<?= $value_detail_sdm_6['id_detail_sdm_6'] ?>,'edit_level_9_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                            ...
                                                                                                                            <a onclick="modal_level_9_sdm(<?= $value_detail_sdm_6['id_detail_sdm_6'] ?>,'urutan_level_9_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                        <?php    } else { ?>
                                                                                                                            ...
                                                                                                                            <a onclick="modal_level_9_sdm(<?= $value_detail_sdm_6['id_detail_sdm_6'] ?>,'tambah_level_9_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                            <a onclick="modal_level_9_sdm(<?= $value_detail_sdm_6['id_detail_sdm_6'] ?>,'hapus_level_9_sdm')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                            <a onclick="modal_level_9_sdm(<?= $value_detail_sdm_6['id_detail_sdm_6'] ?>,'edit_level_9_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                            <a onclick="modal_level_9_sdm(<?= $value_detail_sdm_6['id_detail_sdm_6'] ?>,'tambah_level_9_sdm_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                            <a onclick="modal_level_9_sdm(<?= $value_detail_sdm_6['id_detail_sdm_6'] ?>,'urutan_level_9_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                        <?php   }  ?>
                                                                                                            ...
                                                                                                            <div class="dropdown-menu" role="menu">
                                                                                                                <?php if ($value_detail_sdm_6[$nilai] == null || $value_detail_sdm_6[$nilai] == 0) { ?>
                                                                                                                    <?php if ($kondisi_sdm_detail_7) { ?>
                                                                                                                        <a onclick="modal_level_9_sdm(<?= $value_detail_sdm_6['id_detail_sdm_6'] ?>,'tambah_level_9_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                        <a onclick="modal_level_9_sdm(<?= $value_detail_sdm_6['id_detail_sdm_6'] ?>,'edit_level_9_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                        <a onclick="modal_level_9_sdm(<?= $value_detail_sdm_6['id_detail_sdm_6'] ?>,'tambah_level_9_sdm_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                        <a onclick="modal_level_9_sdm(<?= $value_detail_sdm_6['id_detail_sdm_6'] ?>,'urutan_level_9_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                    <?php    } else { ?>
                                                                                                                        <a onclick="modal_level_9_sdm(<?= $value_detail_sdm_6['id_detail_sdm_6'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                        <a onclick="modal_level_9_sdm(<?= $value_detail_sdm_6['id_detail_sdm_6'] ?>,'tambah_level_9_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                            ...
                                                                                            <div class="modal fade" data-backdrop="false" id="form_modal_level_9_sdm" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                                <div class="modal-dialog" role="document">
                                                                                                    <div class="modal-content">
                                                                                                        ...
                                                                                                        <div class="modal-footer">
                                                                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                            <a href="javascript:;" style="display: none;" id="button_update_nilai_level_9_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_9_sdm('update_nilai_level_9_sdm')">Simpan</a>
                                                                                                            <a href="javascript:;" id="button_tambah_level_9_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_9_sdm('tambah_level_9_sdm')">Update</a>
                                                                                                            <a href="javascript:;" id="button_edit_level_9_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_9_sdm('edit_level_9_sdm')">Edit</a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                                                ...
                                                                                                                <div class="btn-group">
                                                                                                                    ...
                                                                                                                    <div class="dropdown-menu" role="menu">
                                                                                                                        <?php if ($value_detail_sdm_7[$nilai] == null || $value_detail_sdm_7[$nilai] == 0) { ?>
                                                                                                                            <?php if ($kondisi_sdm_detail_7) { ?>
                                                                                                                                <a onclick="modal_level_10_sdm(<?= $value_detail_sdm_7['id_detail_sdm_7'] ?>,'tambah_level_10_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                <a onclick="modal_level_10_sdm(<?= $value_detail_sdm_7['id_detail_sdm_7'] ?>,'edit_level_10_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                ...
                                                                                                                                <a onclick="modal_level_10_sdm(<?= $value_detail_sdm_7['id_detail_sdm_7'] ?>,'urutan_level_10_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                            <?php    } else { ?>
                                                                                                                                ...
                                                                                                                                <a onclick="modal_level_10_sdm(<?= $value_detail_sdm_7['id_detail_sdm_7'] ?>,'tambah_level_10_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                <a onclick="modal_level_10_sdm(<?= $value_detail_sdm_7['id_detail_sdm_7'] ?>,'hapus_level_10_sdm')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                                <a onclick="modal_level_10_sdm(<?= $value_detail_sdm_7['id_detail_sdm_7'] ?>,'edit_level_10_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                <a onclick="modal_level_10_sdm(<?= $value_detail_sdm_7['id_detail_sdm_7'] ?>,'tambah_level_10_sdm_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                                <a onclick="modal_level_10_sdm(<?= $value_detail_sdm_7['id_detail_sdm_7'] ?>,'urutan_level_10_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                            <?php   }  ?>
                                                                                                                ...
                                                                                                                <div class="dropdown-menu" role="menu">
                                                                                                                    <?php if ($value_detail_sdm_7[$nilai] == null || $value_detail_sdm_7[$nilai] == 0) { ?>
                                                                                                                        <?php if ($kondisi_sdm_detail_8) { ?>
                                                                                                                            <a onclick="modal_level_10_sdm(<?= $value_detail_sdm_7['id_detail_sdm_7'] ?>,'tambah_level_10_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                            <a onclick="modal_level_10_sdm(<?= $value_detail_sdm_7['id_detail_sdm_7'] ?>,'edit_level_10_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                            <a onclick="modal_level_10_sdm(<?= $value_detail_sdm_7['id_detail_sdm_7'] ?>,'tambah_level_10_sdm_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                            <a onclick="modal_level_10_sdm(<?= $value_detail_sdm_7['id_detail_sdm_7'] ?>,'urutan_level_10_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                        <?php    } else { ?>
                                                                                                                            <a onclick="modal_level_10_sdm(<?= $value_detail_sdm_7['id_detail_sdm_7'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                            <a onclick="modal_level_10_sdm(<?= $value_detail_sdm_7['id_detail_sdm_7'] ?>,'tambah_level_10_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                ...
                                                                                                <div class="modal fade" data-backdrop="false" id="form_modal_level_10_sdm" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                                    <div class="modal-dialog" role="document">
                                                                                                        <div class="modal-content">
                                                                                                            ...
                                                                                                            <div class="modal-footer">
                                                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                                <a href="javascript:;" style="display: none;" id="button_update_nilai_level_10_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_10_sdm('update_nilai_level_10_sdm')">Simpan</a>
                                                                                                                <a href="javascript:;" id="button_tambah_level_10_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_10_sdm('tambah_level_10_sdm')">Update</a>
                                                                                                                <a href="javascript:;" id="button_edit_level_10_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_10_sdm('edit_level_10_sdm')">Edit</a>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                                    ...
                                                                                                                    <div class="btn-group">
                                                                                                                        ...
                                                                                                                        <div class="dropdown-menu" role="menu">
                                                                                                                            <?php if ($value_detail_sdm_8[$nilai] == null || $value_detail_sdm_8[$nilai] == 0) { ?>
                                                                                                                                <?php if ($kondisi_sdm_detail_7) { ?>
                                                                                                                                    <a onclick="modal_level_11_sdm(<?= $value_detail_sdm_8['id_detail_sdm_8'] ?>,'tambah_level_11_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                    <a onclick="modal_level_11_sdm(<?= $value_detail_sdm_8['id_detail_sdm_8'] ?>,'edit_level_11_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                    ...
                                                                                                                                    <a onclick="modal_level_11_sdm(<?= $value_detail_sdm_8['id_detail_sdm_8'] ?>,'urutan_level_11_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                                <?php    } else { ?>
                                                                                                                                    ...
                                                                                                                                    <a onclick="modal_level_11_sdm(<?= $value_detail_sdm_8['id_detail_sdm_8'] ?>,'tambah_level_11_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                    <a onclick="modal_level_11_sdm(<?= $value_detail_sdm_8['id_detail_sdm_8'] ?>,'hapus_level_11_sdm')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                                    <a onclick="modal_level_11_sdm(<?= $value_detail_sdm_8['id_detail_sdm_8'] ?>,'edit_level_11_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                    <a onclick="modal_level_11_sdm(<?= $value_detail_sdm_8['id_detail_sdm_8'] ?>,'tambah_level_11_sdm_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                                    <a onclick="modal_level_11_sdm(<?= $value_detail_sdm_8['id_detail_sdm_8'] ?>,'urutan_level_11_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                                <?php   }  ?>
                                                                                                                    ...
                                                                                                                    <div class="dropdown-menu" role="menu">
                                                                                                                        <?php if ($value_detail_sdm_8[$nilai] == null || $value_detail_sdm_8[$nilai] == 0) { ?>
                                                                                                                            <?php if ($kondisi_sdm_detail_9) { ?>
                                                                                                                                <a onclick="modal_level_11_sdm(<?= $value_detail_sdm_8['id_detail_sdm_8'] ?>,'tambah_level_11_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                <a onclick="modal_level_11_sdm(<?= $value_detail_sdm_8['id_detail_sdm_8'] ?>,'edit_level_11_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                <a onclick="modal_level_11_sdm(<?= $value_detail_sdm_8['id_detail_sdm_8'] ?>,'tambah_level_11_sdm_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                                <a onclick="modal_level_11_sdm(<?= $value_detail_sdm_8['id_detail_sdm_8'] ?>,'urutan_level_11_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                            <?php    } else { ?>
                                                                                                                                <a onclick="modal_level_11_sdm(<?= $value_detail_sdm_8['id_detail_sdm_8'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                                <a onclick="modal_level_11_sdm(<?= $value_detail_sdm_8['id_detail_sdm_8'] ?>,'tambah_level_11_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                    ...
                                                                                                    <div class="modal fade" data-backdrop="false" id="form_modal_level_11_sdm" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                                        <div class="modal-dialog" role="document">
                                                                                                            <div class="modal-content">
                                                                                                                ...
                                                                                                                <div class="modal-footer">
                                                                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                                    <a href="javascript:;" style="display: none;" id="button_update_nilai_level_11_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_11_sdm('update_nilai_level_11_sdm')">Simpan</a>
                                                                                                                    <a href="javascript:;" id="button_tambah_level_11_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_11_sdm('tambah_level_11_sdm')">Update</a>
                                                                                                                    <a href="javascript:;" id="button_edit_level_11_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_11_sdm('edit_level_11_sdm')">Edit</a>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <?php if ($adendum_result) { ?>
                                                                                                                <?php foreach ($adendum_result as $key => $value) { ?>
                                                                                                                    ...
                                                                                                                    ?>
                                                                                                                    <td class="tg-0lax"> <?= "Rp " . number_format($value_detail_sdm_9[$nilai], 2, ',', '.') ?>
                                                                                                                    </td>
                                                                                                                    <td class="tg-0lax">
                                                                                                                            ...
                                                                                                                            <div class="dropdown-menu" role="menu">
                                                                                                                                <?php if ($value_detail_sdm_9[$nilai] == null || $value_detail_sdm_9[$nilai] == 0) { ?>
                                                                                                                                    <?php if ($kondisi_sdm_detail_10) { ?>
                                                                                                                                        <a onclick="modal_level_12_sdm(<?= $value_detail_sdm_9['id_detail_sdm_9'] ?>,'tambah_level_12_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                        <a onclick="modal_level_12_sdm(<?= $value_detail_sdm_9['id_detail_sdm_9'] ?>,'edit_level_12_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                        ...
                                                                                                                                        <a onclick="modal_level_12_sdm(<?= $value_detail_sdm_9['id_detail_sdm_9'] ?>,'urutan_level_12_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                                    <?php    } else { ?>
                                                                                                                                        ...
                                                                                                                                        <a onclick="modal_level_12_sdm(<?= $value_detail_sdm_9['id_detail_sdm_9'] ?>,'tambah_level_12_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                        <a onclick="modal_level_12_sdm(<?= $value_detail_sdm_9['id_detail_sdm_9'] ?>,'hapus_level_12_sdm')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                                        <a onclick="modal_level_12_sdm(<?= $value_detail_sdm_9['id_detail_sdm_9'] ?>,'edit_level_12_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                        <a onclick="modal_level_12_sdm(<?= $value_detail_sdm_9['id_detail_sdm_9'] ?>,'tambah_level_12_sdm_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                                        <a onclick="modal_level_12_sdm(<?= $value_detail_sdm_9['id_detail_sdm_9'] ?>,'urutan_level_12_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                                    <?php   }  ?>
                                                                                                                        ...
                                                                                                                        <div class="dropdown-menu" role="menu">
                                                                                                                            <?php if ($value_detail_sdm_9[$nilai] == null || $value_detail_sdm_9[$nilai] == 0) { ?>
                                                                                                                                <?php if ($kondisi_sdm_detail_10) { ?>
                                                                                                                                    <a onclick="modal_level_12_sdm(<?= $value_detail_sdm_9['id_detail_sdm_9'] ?>,'tambah_level_12_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                    <a onclick="modal_level_12_sdm(<?= $value_detail_sdm_9['id_detail_sdm_9'] ?>,'edit_level_12_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                    <a onclick="modal_level_12_sdm(<?= $value_detail_sdm_9['id_detail_sdm_9'] ?>,'tambah_level_12_sdm_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                                    <a onclick="modal_level_12_sdm(<?= $value_detail_sdm_9['id_detail_sdm_9'] ?>,'urutan_level_12_sdm')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                                <?php    } else { ?>
                                                                                                                                    <a onclick="modal_level_12_sdm(<?= $value_detail_sdm_9['id_detail_sdm_9'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                                    <a onclick="modal_level_12_sdm(<?= $value_detail_sdm_9['id_detail_sdm_9'] ?>,'tambah_level_12_sdm')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                        ...
                                                                                                        <div class="modal fade" data-backdrop="false" id="form_modal_level_12_sdm" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                                            <div class="modal-dialog" role="document">
                                                                                                                <div class="modal-content">
                                                                                                                    ...
                                                                                                                    <div class="modal-footer">
                                                                                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                                        <a href="javascript:;" style="display: none;" id="button_update_nilai_level_12_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_12_sdm('update_nilai_level_12_sdm')">Simpan</a>
                                                                                                                        <a href="javascript:;" id="button_tambah_level_12_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_12_sdm('tambah_level_12_sdm')">Update</a>
                                                                                                                        <a href="javascript:;" id="button_edit_level_12_sdm" class="btn btn-success button_simpan" onclick="Simpan_level_12_sdm('edit_level_12_sdm')">Edit</a>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
