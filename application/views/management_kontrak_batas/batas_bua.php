                                                                ...
                                                                foreach ($query_result_bua->result_array() as $value_bua) { ?>
                                                                    ...
                                                                    <tr class="bg-danger text-white" style="font-size:12px;font-weight:700">
                                                                        ...
                                                                        <?php if ($adendum_result) { ?>
                                                                            <?php foreach ($adendum_result as $key => $value) { ?>
                                                                                ...
                                                                                ?>
                                                                                <td class="tg-0lax text-white"> <?= "Rp " . number_format($value_bua[$nilai], 2, ',', '.') ?>
                                                                                </td>
                                                                                <td class="tg-0lax">
                                                                                    <div class="btn-group">
                                                                                        ...
                                                                                        <div class="dropdown-menu" role="menu">
                                                                                            <?php if ($value_bua[$nilai] == null || $value_bua[$nilai] == 0) { ?>
                                                                                                <?php if ($kondisi_detail_bua) { ?>
                                                                                                    <a onclick="modal_level_2_bua(<?= $value_bua['id_bua'] ?>,'tambah_level_2_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                ...
                                                                                <div class="btn-group">
                                                                                    ...
                                                                                    <div class="dropdown-menu" role="menu">
                                                                                        <?php if ($value_bua[$nilai] == null || $value_bua[$nilai] == 0) { ?>
                                                                                            <?php if ($kondisi_detail_bua) { ?>
                                                                                                <a onclick="modal_level_2_bua(<?= $value_bua['id_bua'] ?>,'tambah_level_2_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                <a onclick="modal_level_2_bua(<?= $value_bua['id_bua'] ?>,'tambah_level_2_bua_excel',null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                            <?php    } else { ?>
                                                                                                <a onclick="modal_level_2_bua(<?= $value_bua['id_bua'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                <a onclick="modal_level_2_bua(<?= $value_bua['id_bua'] ?>,'tambah_level_2_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                <a onclick="modal_level_2_bua(<?= $value_bua['id_bua'] ?>,'tambah_level_2_bua_excel',null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                        ...
                                                                                        <div class="dropdown-menu" role="menu">
                                                                                            <?php if ($value_detail_bua[$nilai] == null || $value_detail_bua[$nilai] == 0) { ?>
                                                                                                <?php if ($kondisi_bua_detail_1) { ?>
                                                                                                    <a onclick="modal_level_3_bua(<?= $value_detail_bua['id_bua_detail'] ?>,'tambah_level_3_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                    <a onclick="modal_level_3_bua(<?= $value_detail_bua['id_bua_detail'] ?>,'edit_level_3_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                    <!-- UBAH urutan -->
                                                                                                    ...
                                                                                                    <a onclick="modal_level_3_bua(<?= $value_detail_bua['id_bua_detail'] ?>,'urutan_level_3_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                <?php    } else { ?>
                                                                                                    ...
                                                                                                    <a onclick="modal_level_3_bua(<?= $value_detail_bua['id_bua_detail'] ?>,'tambah_level_3_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                    <a onclick="modal_level_3_bua(<?= $value_detail_bua['id_bua_detail'] ?>,'hapus_level_3_bua')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                    <a onclick="modal_level_3_bua(<?= $value_detail_bua['id_bua_detail'] ?>,'edit_level_3_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                    <a onclick="modal_level_3_bua(<?= $value_detail_bua['id_bua_detail'] ?>,'tambah_level_3_bua_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                    <!-- UBAH urutan -->
                                                                                                    <a onclick="modal_level_3_bua(<?= $value_detail_bua['id_bua_detail'] ?>,'urutan_level_3_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                            ...
                                                                                            <?php } else { ?>
                                                                                                <?php if ($kondisi_bua_detail_1) { ?>
                                                                                                    <a onclick="modal_level_3_bua(<?= $value_detail_bua['id_bua_detail'] ?>,'tambah_level_3_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                    <a onclick="modal_level_3_bua(<?= $value_detail_bua['id_bua_detail'] ?>,'edit_level_3_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                    <a onclick="modal_level_3_bua(<?= $value_detail_bua['id_bua_detail'] ?>,'tambah_level_3_bua_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                    <!-- UBAH urutan -->
                                                                                                    <a onclick="modal_level_3_bua(<?= $value_detail_bua['id_bua_detail'] ?>,'urutan_level_3_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                <?php    } else { ?>
                                                                                                    <a onclick="modal_level_3_bua(<?= $value_detail_bua['id_bua_detail'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                    ...
                                                                    <?php
                                                                                        ...
                                                                                        <div class="btn-group">
                                                                                            ...
                                                                                            <div class="dropdown-menu" role="menu">
                                                                                                <?php if ($value_detail_bua_1[$nilai] == null || $value_detail_bua_1[$nilai] == 0) { ?>
                                                                                                    <?php if ($kondisi_bua_detail_1) { ?>
                                                                                                        <a onclick="modal_level_4_bua(<?= $value_detail_bua_1['id_detail_bua_1'] ?>,'tambah_level_4_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                        <a onclick="modal_level_4_bua(<?= $value_detail_bua_1['id_detail_bua_1'] ?>,'edit_level_4_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                        ...
                                                                                                        <a onclick="modal_level_4_bua(<?= $value_detail_bua_1['id_detail_bua_1'] ?>,'urutan_level_4_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                    <?php    } else { ?>
                                                                                                        ...
                                                                                                        <a onclick="modal_level_4_bua(<?= $value_detail_bua_1['id_detail_bua_1'] ?>,'tambah_level_4_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                        <a onclick="modal_level_4_bua(<?= $value_detail_bua_1['id_detail_bua_1'] ?>,'hapus_level_4_bua')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                        <a onclick="modal_level_4_bua(<?= $value_detail_bua_1['id_detail_bua_1'] ?>,'edit_level_4_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                        <a onclick="modal_level_4_bua(<?= $value_detail_bua_1['id_detail_bua_1'] ?>,'tambah_level_4_bua_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                        <a onclick="modal_level_4_bua(<?= $value_detail_bua_1['id_detail_bua_1'] ?>,'urutan_level_4_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                    <?php   }  ?>
                                                                                        ...
                                                                                        <div class="dropdown-menu" role="menu">
                                                                                            <?php if ($value_detail_bua_1[$nilai] == null || $value_detail_bua_1[$nilai] == 0) { ?>
                                                                                                <?php if ($kondisi_bua_detail_1) { ?>
                                                                                                    <a onclick="modal_level_4_bua(<?= $value_detail_bua_1['id_detail_bua_1'] ?>,'tambah_level_4_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                    <a onclick="modal_level_4_bua(<?= $value_detail_bua_1['id_detail_bua_1'] ?>,'edit_level_4_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                    <a onclick="modal_level_4_bua(<?= $value_detail_bua_1['id_detail_bua_1'] ?>,'tambah_level_4_bua_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                    <a onclick="modal_level_4_bua(<?= $value_detail_bua_1['id_detail_bua_1'] ?>,'urutan_level_4_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                <?php    } else { ?>
                                                                                                    <a onclick="modal_level_4_bua(<?= $value_detail_bua_1['id_detail_bua_1'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                    <a onclick="modal_level_4_bua(<?= $value_detail_bua_1['id_detail_bua_1'] ?>,'tambah_level_4_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            <tr class="text-success" style="font-size:11px;font-weight: 400;">
                                                                                <td class="tg-0lax">
                                                                                    <?= $value_detail_bua_2['no_urut_2_bua'] ?> </td>
                                                                                </td>
                                                                                <td class="tg-0lax" style="white-space: nowrap; width: 300px;overflow: hidden;text-overflow: ellipsis;" title="<?= $value_detail_bua_2['nama_uraian_2_bua'] ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<?= $value_detail_bua_2['nama_uraian_2_bua'] ?></td>
                                                                                <?php if ($adendum_result) { ?>
                                                                                    <?php foreach ($adendum_result as $key => $value) { ?>
                                                                                        <?php
                                                                                            if ($value['no_adendum'] == 1) {
                                                                                                ...
                                                                                                <div class="dropdown-menu" role="menu">
                                                                                                    <?php if ($value_detail_bua_2[$nilai] == null || $value_detail_bua_2[$nilai] == 0) { ?>
                                                                                                        <?php if ($kondisi_bua_detail_2) { ?>
                                                                                                            <a onclick="modal_level_5_bua(<?= $value_detail_bua_2['id_detail_bua_2'] ?>,'tambah_level_5_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                            <a onclick="modal_level_5_bua(<?= $value_detail_bua_2['id_detail_bua_2'] ?>,'edit_level_5_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                            ...
                                                                                                            <a onclick="modal_level_5_bua(<?= $value_detail_bua_2['id_detail_bua_2'] ?>,'urutan_level_5_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                        <?php    } else { ?>
                                                                                                            ...
                                                                                                            <a onclick="modal_level_5_bua(<?= $value_detail_bua_2['id_detail_bua_2'] ?>,'tambah_level_5_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                            <a onclick="modal_level_5_bua(<?= $value_detail_bua_2['id_detail_bua_2'] ?>,'hapus_level_5_bua')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                            <a onclick="modal_level_5_bua(<?= $value_detail_bua_2['id_detail_bua_2'] ?>,'edit_level_5_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                            <a onclick="modal_level_5_bua(<?= $value_detail_bua_2['id_detail_bua_2'] ?>,'tambah_level_5_bua_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                            <a onclick="modal_level_5_bua(<?= $value_detail_bua_2['id_detail_bua_2'] ?>,'urutan_level_5_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                        <?php   }  ?>
                                                                                            ...
                                                                                            <div class="dropdown-menu" role="menu">
                                                                                                <?php if ($value_detail_bua_2[$nilai] == null || $value_detail_bua_2[$nilai] == 0) { ?>
                                                                                                    <?php if ($kondisi_bua_detail_2) { ?>
                                                                                                        <a onclick="modal_level_5_bua(<?= $value_detail_bua_2['id_detail_bua_2'] ?>,'tambah_level_5_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                        <a onclick="modal_level_5_bua(<?= $value_detail_bua_2['id_detail_bua_2'] ?>,'edit_level_5_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                        <a onclick="modal_level_5_bua(<?= $value_detail_bua_2['id_detail_bua_2'] ?>,'tambah_level_5_bua_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                        <a onclick="modal_level_5_bua(<?= $value_detail_bua_2['id_detail_bua_2'] ?>,'urutan_level_5_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                    <?php    } else { ?>
                                                                                                        <a onclick="modal_level_5_bua(<?= $value_detail_bua_2['id_detail_bua_2'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                        <a onclick="modal_level_5_bua(<?= $value_detail_bua_2['id_detail_bua_2'] ?>,'tambah_level_5_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                <tr class="text-danger" style="font-size:11px;font-weight: 350;">
                                                                                    <td class="tg-0lax">
                                                                                                    ...
                                                                                                    <div class="dropdown-menu" role="menu">
                                                                                                        <?php if ($value_detail_bua_3[$nilai] == null || $value_detail_bua_3[$nilai] == 0) { ?>
                                                                                                            <?php if ($kondisi_bua_detail_4) { ?>
                                                                                                                <a onclick="modal_level_6_bua(<?= $value_detail_bua_3['id_detail_bua_3'] ?>,'tambah_level_6_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                <a onclick="modal_level_6_bua(<?= $value_detail_bua_3['id_detail_bua_3'] ?>,'edit_level_6_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                ...
                                                                                                                <a onclick="modal_level_6_bua(<?= $value_detail_bua_3['id_detail_bua_3'] ?>,'urutan_level_6_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                            <?php    } else { ?>
                                                                                                                ...
                                                                                                                <a onclick="modal_level_6_bua(<?= $value_detail_bua_3['id_detail_bua_3'] ?>,'tambah_level_6_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                <a onclick="modal_level_6_bua(<?= $value_detail_bua_3['id_detail_bua_3'] ?>,'hapus_level_6_bua')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                <a onclick="modal_level_6_bua(<?= $value_detail_bua_3['id_detail_bua_3'] ?>,'edit_level_6_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                <a onclick="modal_level_6_bua(<?= $value_detail_bua_3['id_detail_bua_3'] ?>,'tambah_level_6_bua_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                ...
                                                                                                <div class="dropdown-menu" role="menu">
                                                                                                    <?php if ($value_detail_bua_3[$nilai] == null || $value_detail_bua_3[$nilai] == 0) { ?>
                                                                                                        <?php if ($kondisi_bua_detail_4) { ?>
                                                                                                            <a onclick="modal_level_6_bua(<?= $value_detail_bua_3['id_detail_bua_3'] ?>,'tambah_level_6_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                            <a onclick="modal_level_6_bua(<?= $value_detail_bua_3['id_detail_bua_3'] ?>,'edit_level_6_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                            <a onclick="modal_level_6_bua(<?= $value_detail_bua_3['id_detail_bua_3'] ?>,'tambah_level_6_bua_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                            <a onclick="modal_level_6_bua(<?= $value_detail_bua_3['id_detail_bua_3'] ?>,'urutan_level_6_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                        <?php    } else { ?>
                                                                                                            <a onclick="modal_level_6_bua(<?= $value_detail_bua_3['id_detail_bua_3'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                            <a onclick="modal_level_6_bua(<?= $value_detail_bua_3['id_detail_bua_3'] ?>,'tambah_level_6_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                        ...
                                                                                                        <div class="dropdown-menu" role="menu">
                                                                                                            <?php if ($value_detail_bua_4[$nilai] == null || $value_detail_bua_4[$nilai] == 0) { ?>
                                                                                                                <?php if ($kondisi_bua_detail_5) { ?>
                                                                                                                    <a onclick="modal_level_7_bua(<?= $value_detail_bua_4['id_detail_bua_4'] ?>,'tambah_level_7_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                    <a onclick="modal_level_7_bua(<?= $value_detail_bua_4['id_detail_bua_4'] ?>,'edit_level_7_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                    <a onclick="modal_level_7_bua(<?= $value_detail_bua_4['id_detail_bua_4'] ?>,'urutan_level_7_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                <?php    } else { ?>
                                                                                                                    ...
                                                                                                                    <a onclick="modal_level_7_bua(<?= $value_detail_bua_4['id_detail_bua_4'] ?>,'tambah_level_7_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                    <a onclick="modal_level_7_bua(<?= $value_detail_bua_4['id_detail_bua_4'] ?>,'hapus_level_7_bua')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                    <a onclick="modal_level_7_bua(<?= $value_detail_bua_4['id_detail_bua_4'] ?>,'edit_level_7_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                    ...
                                                                                                    <div class="dropdown-menu" role="menu">
                                                                                                        <?php if ($value_detail_bua_4[$nilai] == null || $value_detail_bua_4[$nilai] == 0) { ?>
                                                                                                            <?php if ($kondisi_bua_detail_5) { ?>
                                                                                                                <a onclick="modal_level_7_bua(<?= $value_detail_bua_4['id_detail_bua_4'] ?>,'tambah_level_7_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                <a onclick="modal_level_7_bua(<?= $value_detail_bua_4['id_detail_bua_4'] ?>,'edit_level_7_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                <a onclick="modal_level_7_bua(<?= $value_detail_bua_4['id_detail_bua_4'] ?>,'tambah_level_7_bua_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                <a onclick="modal_level_7_bua(<?= $value_detail_bua_4['id_detail_bua_4'] ?>,'urutan_level_7_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                            <?php    } else { ?>
                                                                                                                <a onclick="modal_level_7_bua(<?= $value_detail_bua_4['id_detail_bua_4'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                <a onclick="modal_level_7_bua(<?= $value_detail_bua_4['id_detail_bua_4'] ?>,'tambah_level_7_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                            ...
                                                                                                            <div class="dropdown-menu" role="menu">
                                                                                                                <?php if ($value_detail_bua_5[$nilai] == null || $value_detail_bua_5[$nilai] == 0) { ?>
                                                                                                                    <?php if ($kondisi_bua_detail_6) { ?>
                                                                                                                        <a onclick="modal_level_8_bua(<?= $value_detail_bua_5['id_detail_bua_5'] ?>,'tambah_level_8_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                        <a onclick="modal_level_8_bua(<?= $value_detail_bua_5['id_detail_bua_5'] ?>,'edit_level_8_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                        ...
                                                                                                                        <a onclick="modal_level_8_bua(<?= $value_detail_bua_5['id_detail_bua_5'] ?>,'urutan_level_8_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                    <?php    } else { ?>
                                                                                                                        ...
                                                                                                                        <a onclick="modal_level_8_bua(<?= $value_detail_bua_5['id_detail_bua_5'] ?>,'tambah_level_8_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                        <a onclick="modal_level_8_bua(<?= $value_detail_bua_5['id_detail_bua_5'] ?>,'hapus_level_8_bua')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                        <a onclick="modal_level_8_bua(<?= $value_detail_bua_5['id_detail_bua_5'] ?>,'edit_level_8_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                        <a onclick="modal_level_8_bua(<?= $value_detail_bua_5['id_detail_bua_5'] ?>,'tambah_level_8_bua_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                        <a onclick="modal_level_8_bua(<?= $value_detail_bua_5['id_detail_bua_5'] ?>,'urutan_level_8_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                    <?php   }  ?>
                                                                                                        ...
                                                                                                        <div class="dropdown-menu" role="menu">
                                                                                                            <?php if ($value_detail_bua_5[$nilai] == null || $value_detail_bua_5[$nilai] == 0) { ?>
                                                                                                                <?php if ($kondisi_bua_detail_6) { ?>
                                                                                                                    <a onclick="modal_level_8_bua(<?= $value_detail_bua_5['id_detail_bua_5'] ?>,'tambah_level_8_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                    <a onclick="modal_level_8_bua(<?= $value_detail_bua_5['id_detail_bua_5'] ?>,'edit_level_8_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                    <a onclick="modal_level_8_bua(<?= $value_detail_bua_5['id_detail_bua_5'] ?>,'tambah_level_8_bua_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                    <a onclick="modal_level_8_bua(<?= $value_detail_bua_5['id_detail_bua_5'] ?>,'urutan_level_8_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                <?php    } else { ?>
                                                                                                                    <a onclick="modal_level_8_bua(<?= $value_detail_bua_5['id_detail_bua_5'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                    <a onclick="modal_level_8_bua(<?= $value_detail_bua_5['id_detail_bua_5'] ?>,'tambah_level_8_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                ...
                                                                                                                <div class="dropdown-menu" role="menu">
                                                                                                                    <?php if ($value_detail_bua_6[$nilai] == null || $value_detail_bua_6[$nilai] == 0) { ?>
                                                                                                                        <?php if ($kondisi_bua_detail_7) { ?>
                                                                                                                            <a onclick="modal_level_9_bua(<?= $value_detail_bua_6['id_detail_bua_6'] ?>,'tambah_level_9_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                            <a onclick="modal_level_9_bua(<?= $value_detail_bua_6['id_detail_bua_6'] ?>,'edit_level_9_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                            ...
                                                                                                                            <a onclick="modal_level_9_bua(<?= $value_detail_bua_6['id_detail_bua_6'] ?>,'urutan_level_9_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                        <?php    } else { ?>
                                                                                                                            ...
                                                                                                                            <a onclick="modal_level_9_bua(<?= $value_detail_bua_6['id_detail_bua_6'] ?>,'tambah_level_9_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                            <a onclick="modal_level_9_bua(<?= $value_detail_bua_6['id_detail_bua_6'] ?>,'hapus_level_9_bua')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                            <a onclick="modal_level_9_bua(<?= $value_detail_bua_6['id_detail_bua_6'] ?>,'edit_level_9_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                            <a onclick="modal_level_9_bua(<?= $value_detail_bua_6['id_detail_bua_6'] ?>,'tambah_level_9_bua_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                            <a onclick="modal_level_9_bua(<?= $value_detail_bua_6['id_detail_bua_6'] ?>,'urutan_level_9_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                        <?php   }  ?>
                                                                                                            ...
                                                                                                            <div class="dropdown-menu" role="menu">
                                                                                                                <?php if ($value_detail_bua_6[$nilai] == null || $value_detail_bua_6[$nilai] == 0) { ?>
                                                                                                                    <?php if ($kondisi_bua_detail_7) { ?>
                                                                                                                        <a onclick="modal_level_9_bua(<?= $value_detail_bua_6['id_detail_bua_6'] ?>,'tambah_level_9_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                        <a onclick="modal_level_9_bua(<?= $value_detail_bua_6['id_detail_bua_6'] ?>,'edit_level_9_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                        <a onclick="modal_level_9_bua(<?= $value_detail_bua_6['id_detail_bua_6'] ?>,'tambah_level_9_bua_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                        <a onclick="modal_level_9_bua(<?= $value_detail_bua_6['id_detail_bua_6'] ?>,'urutan_level_9_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                    <?php    } else { ?>
                                                                                                                        <a onclick="modal_level_9_bua(<?= $value_detail_bua_6['id_detail_bua_6'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                        <a onclick="modal_level_9_bua(<?= $value_detail_bua_6['id_detail_bua_6'] ?>,'tambah_level_9_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                ...
                                                                                                                <div class="btn-group">
                                                                                                                    ...
                                                                                                                    <div class="dropdown-menu" role="menu">
                                                                                                                        <?php if ($value_detail_bua_7[$nilai] == null || $value_detail_bua_7[$nilai] == 0) { ?>
                                                                                                                            <?php if ($kondisi_bua_detail_7) { ?>
                                                                                                                                <a onclick="modal_level_10_bua(<?= $value_detail_bua_7['id_detail_bua_7'] ?>,'tambah_level_10_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                <a onclick="modal_level_10_bua(<?= $value_detail_bua_7['id_detail_bua_7'] ?>,'edit_level_10_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                ...
                                                                                                                                <a onclick="modal_level_10_bua(<?= $value_detail_bua_7['id_detail_bua_7'] ?>,'urutan_level_10_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                            <?php    } else { ?>
                                                                                                                                ...
                                                                                                                                <a onclick="modal_level_10_bua(<?= $value_detail_bua_7['id_detail_bua_7'] ?>,'tambah_level_10_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                <a onclick="modal_level_10_bua(<?= $value_detail_bua_7['id_detail_bua_7'] ?>,'hapus_level_10_bua')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                                <a onclick="modal_level_10_bua(<?= $value_detail_bua_7['id_detail_bua_7'] ?>,'edit_level_10_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                <a onclick="modal_level_10_bua(<?= $value_detail_bua_7['id_detail_bua_7'] ?>,'tambah_level_10_bua_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                                <a onclick="modal_level_10_bua(<?= $value_detail_bua_7['id_detail_bua_7'] ?>,'urutan_level_10_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                            <?php   }  ?>
                                                                                                                ...
                                                                                                                <div class="dropdown-menu" role="menu">
                                                                                                                    <?php if ($value_detail_bua_7[$nilai] == null || $value_detail_bua_7[$nilai] == 0) { ?>
                                                                                                                        <?php if ($kondisi_bua_detail_8) { ?>
                                                                                                                            <a onclick="modal_level_10_bua(<?= $value_detail_bua_7['id_detail_bua_7'] ?>,'tambah_level_10_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                            <a onclick="modal_level_10_bua(<?= $value_detail_bua_7['id_detail_bua_7'] ?>,'edit_level_10_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                            <a onclick="modal_level_10_bua(<?= $value_detail_bua_7['id_detail_bua_7'] ?>,'tambah_level_10_bua_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                            <a onclick="modal_level_10_bua(<?= $value_detail_bua_7['id_detail_bua_7'] ?>,'urutan_level_10_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                        <?php    } else { ?>
                                                                                                                            <a onclick="modal_level_10_bua(<?= $value_detail_bua_7['id_detail_bua_7'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                            <a onclick="modal_level_10_bua(<?= $value_detail_bua_7['id_detail_bua_7'] ?>,'tambah_level_10_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                    ...
                                                                                                                    <div class="btn-group">
                                                                                                                        ...
                                                                                                                        <div class="dropdown-menu" role="menu">
                                                                                                                            <?php if ($value_detail_bua_8[$nilai] == null || $value_detail_bua_8[$nilai] == 0) { ?>
                                                                                                                                <?php if ($kondisi_bua_detail_7) { ?>
                                                                                                                                    <a onclick="modal_level_11_bua(<?= $value_detail_bua_8['id_detail_bua_8'] ?>,'tambah_level_11_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                    <a onclick="modal_level_11_bua(<?= $value_detail_bua_8['id_detail_bua_8'] ?>,'edit_level_11_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                    ...
                                                                                                                                    <a onclick="modal_level_11_bua(<?= $value_detail_bua_8['id_detail_bua_8'] ?>,'urutan_level_11_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                                <?php    } else { ?>
                                                                                                                                    ...
                                                                                                                                    <a onclick="modal_level_11_bua(<?= $value_detail_bua_8['id_detail_bua_8'] ?>,'tambah_level_11_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                    <a onclick="modal_level_11_bua(<?= $value_detail_bua_8['id_detail_bua_8'] ?>,'hapus_level_11_bua')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                                    <a onclick="modal_level_11_bua(<?= $value_detail_bua_8['id_detail_bua_8'] ?>,'edit_level_11_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                    <a onclick="modal_level_11_bua(<?= $value_detail_bua_8['id_detail_bua_8'] ?>,'tambah_level_11_bua_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                                    <a onclick="modal_level_11_bua(<?= $value_detail_bua_8['id_detail_bua_8'] ?>,'urutan_level_11_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                                <?php   }  ?>
                                                                                                                    ...
                                                                                                                    <div class="dropdown-menu" role="menu">
                                                                                                                        <?php if ($value_detail_bua_8[$nilai] == null || $value_detail_bua_8[$nilai] == 0) { ?>
                                                                                                                            <?php if ($kondisi_bua_detail_9) { ?>
                                                                                                                                <a onclick="modal_level_11_bua(<?= $value_detail_bua_8['id_detail_bua_8'] ?>,'tambah_level_11_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                <a onclick="modal_level_11_bua(<?= $value_detail_bua_8['id_detail_bua_8'] ?>,'edit_level_11_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                <a onclick="modal_level_11_bua(<?= $value_detail_bua_8['id_detail_bua_8'] ?>,'tambah_level_11_bua_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                                <a onclick="modal_level_11_bua(<?= $value_detail_bua_8['id_detail_bua_8'] ?>,'urutan_level_11_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                            <?php    } else { ?>
                                                                                                                                <a onclick="modal_level_11_bua(<?= $value_detail_bua_8['id_detail_bua_8'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                                <a onclick="modal_level_11_bua(<?= $value_detail_bua_8['id_detail_bua_8'] ?>,'tambah_level_11_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <?php if ($adendum_result) { ?>
                                                                                                                <?php foreach ($adendum_result as $key => $value) { ?>
                                                                                                                    ...
                                                                                                                    ?>
                                                                                                                    <td class="tg-0lax"> <?= "Rp " . number_format($value_detail_bua_9[$nilai], 2, ',', '.') ?>
                                                                                                                    </td>
                                                                                                                    <td class="tg-0lax">
                                                                                                                            ...
                                                                                                                            <div class="dropdown-menu" role="menu">
                                                                                                                                <?php if ($value_detail_bua_9[$nilai] == null || $value_detail_bua_9[$nilai] == 0) { ?>
                                                                                                                                    <?php if ($kondisi_bua_detail_10) { ?>
                                                                                                                                        <a onclick="modal_level_12_bua(<?= $value_detail_bua_9['id_detail_bua_9'] ?>,'tambah_level_12_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                        <a onclick="modal_level_12_bua(<?= $value_detail_bua_9['id_detail_bua_9'] ?>,'edit_level_12_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                        ...
                                                                                                                                        <a onclick="modal_level_12_bua(<?= $value_detail_bua_9['id_detail_bua_9'] ?>,'urutan_level_12_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                                    <?php    } else { ?>
                                                                                                                                        ...
                                                                                                                                        <a onclick="modal_level_12_bua(<?= $value_detail_bua_9['id_detail_bua_9'] ?>,'tambah_level_12_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                        <a onclick="modal_level_12_bua(<?= $value_detail_bua_9['id_detail_bua_9'] ?>,'hapus_level_12_bua')" class="btn btn-sm btn-danger" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Hapus Turunan"><i class="fas fa-trash"></i></a>
                                                                                                                                        <a onclick="modal_level_12_bua(<?= $value_detail_bua_9['id_detail_bua_9'] ?>,'edit_level_12_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                        <a onclick="modal_level_12_bua(<?= $value_detail_bua_9['id_detail_bua_9'] ?>,'tambah_level_12_bua_excel', <?= $type_add_nilai ?>)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                                        <a onclick="modal_level_12_bua(<?= $value_detail_bua_9['id_detail_bua_9'] ?>,'urutan_level_12_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                                    <?php   }  ?>
                                                                                                                        ...
                                                                                                                        <div class="dropdown-menu" role="menu">
                                                                                                                            <?php if ($value_detail_bua_9[$nilai] == null || $value_detail_bua_9[$nilai] == 0) { ?>
                                                                                                                                <?php if ($kondisi_bua_detail_10) { ?>
                                                                                                                                    <a onclick="modal_level_12_bua(<?= $value_detail_bua_9['id_detail_bua_9'] ?>,'tambah_level_12_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
                                                                                                                                    <a onclick="modal_level_12_bua(<?= $value_detail_bua_9['id_detail_bua_9'] ?>,'edit_level_12_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Edit Turunan"><i class="fas fa-edit"></i></a>
                                                                                                                                    <a onclick="modal_level_12_bua(<?= $value_detail_bua_9['id_detail_bua_9'] ?>,'tambah_level_12_bua_excel', null)" class="btn btn-sm btn-success" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Dengan Excel"><i class="fas fa-file"></i></a>
                                                                                                                                    <a onclick="modal_level_12_bua(<?= $value_detail_bua_9['id_detail_bua_9'] ?>,'urutan_level_12_bua')" class="btn btn-sm btn-info" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Pindahkan Level Turunan"><i class="fas fa fa-list-ol"></i></a>
                                                                                                                                <?php    } else { ?>
                                                                                                                                    <a onclick="modal_level_12_bua(<?= $value_detail_bua_9['id_detail_bua_9'] ?>,'<?= $update_reusable ?>')" class="btn btn-sm btn-warning" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Masukan Nilai Turunan"><i class="fas fa-dollar-sign"></i></a>
                                                                                                                                    <a onclick="modal_level_12_bua(<?= $value_detail_bua_9['id_detail_bua_9'] ?>,'tambah_level_12_bua')" class="btn btn-sm btn-primary" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Tambah Turunan"><i class="fas fa-plus"></i></a>
