...
<script>
    ...
    function modal_level_3_sdm(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_3_sdm') {
                    Question_detail_sdm(response['row_sdm_detail'].nama_uraian, response['row_sdm_detail'].id_sdm_detail, response['row_sdm_detail'].id_sdm)
                }
                ...
                if (type == 'urutan_level_3_sdm') {
                    ...
                    for (i = 0; i < response['result_sdm'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_sdm(' + response['result_sdm'][i].id_sdm_detail + ',4.1' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_sdm'][i].no_urut + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_detail_sdm(ket, id, id_sdm) {
        Swal.fire({
...
<script>
    ...
    function modal_level_4_sdm(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_4_sdm') {
                    Question_level_4_sdm(response['row_sdm_detail_1'].nama_uraian_1_sdm, response['row_sdm_detail_1'].id_detail_sdm_1, response['row_sdm_detail_1'].id_sdm_detail)
                }
                ...
                if (type == 'urutan_level_4_sdm') {
                    ...
                    for (i = 0; i < response['result_detail_sdm_1'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_sdm(' + response['result_detail_sdm_1'][i].id_detail_sdm_1 + ',4.2' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_sdm_1'][i].no_urut_1_sdm + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_4_sdm(ket, id, id_sdm_detail) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_5_sdm(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_5_sdm') {
                    Question_level_5_sdm(response['row_sdm_detail_2'].nama_uraian_2_sdm, response['row_sdm_detail_2'].id_detail_sdm_2, response['row_sdm_detail_2'].id_detail_sdm_1)
                }
                // _2
                if (type == 'urutan_level_5_sdm') {
                    modal_sdm_urutan.modal('show')
                    ...
                    for (i = 0; i < response['result_detail_sdm_2'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_sdm(' + response['result_detail_sdm_2'][i].id_detail_sdm_2 + ',4.3' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_sdm_2'][i].no_urut_2_sdm + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_5_sdm(ket, id, id_detail_sdm_1) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_6_sdm(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_6_sdm') {
                    Question_level_6_sdm(response['row_sdm_detail_3'].nama_uraian_3_sdm, response['row_sdm_detail_3'].id_detail_sdm_3, response['row_sdm_detail_3'].id_detail_sdm_2)
                }
                // _3
                if (type == 'urutan_level_6_sdm') {
                    modal_sdm_urutan.modal('show')
                    ...
                    for (i = 0; i < response['result_detail_sdm_3'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_sdm(' + response['result_detail_sdm_3'][i].id_detail_sdm_3 + ',4.4' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_sdm_3'][i].no_urut_3_sdm + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_6_sdm(ket, id, id_detail_sdm_2) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_7_sdm(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_7_sdm') {
                    Question_level_7_sdm(response['row_sdm_detail_4'].nama_uraian_4_sdm, response['row_sdm_detail_4'].id_detail_sdm_4, response['row_sdm_detail_4'].id_detail_sdm_3)
                }
                ...
                if (type == 'urutan_level_7_sdm') {
                    ...
                    for (i = 0; i < response['result_detail_sdm_4'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_sdm(' + response['result_detail_sdm_4'][i].id_detail_sdm_4 + ',4.5' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_sdm_4'][i].no_urut_4_sdm + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_7_sdm(ket, id, id_detail_sdm_3) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_8_sdm(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_8_sdm') {
                    Question_level_8_sdm(response['row_sdm_detail_5'].nama_uraian_5_sdm, response['row_sdm_detail_5'].id_detail_sdm_5, response['row_sdm_detail_5'].id_detail_sdm_4)
                }
                ...
                if (type == 'urutan_level_8_sdm') {
                    ...
                    for (i = 0; i < response['result_detail_sdm_5'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_sdm(' + response['result_detail_sdm_5'][i].id_detail_sdm_5 + ',4.6' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_sdm_5'][i].no_urut_5_sdm + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_8_sdm(ket, id, id_detail_sdm_4) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_9_sdm(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_9_sdm') {
                    Question_level_9_sdm(response['row_sdm_detail_6'].nama_uraian_6_sdm, response['row_sdm_detail_6'].id_detail_sdm_6, response['row_sdm_detail_6'].id_detail_sdm_5)
                }
                ...
                if (type == 'urutan_level_9_sdm') {
                    ...
                    for (i = 0; i < response['result_detail_sdm_6'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_sdm(' + response['result_detail_sdm_6'][i].id_detail_sdm_6 + ',4.7' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_sdm_6'][i].no_urut_6_sdm + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_9_sdm(ket, id, id_detail_sdm_5) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_10_sdm(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_10_sdm') {
                    Question_level_10_sdm(response['row_sdm_detail_7'].nama_uraian_7_sdm, response['row_sdm_detail_7'].id_detail_sdm_7, response['row_sdm_detail_7'].id_detail_sdm_6)
                }
                ...
                if (type == 'urutan_level_10_sdm') {
                    ...
                    for (i = 0; i < response['result_detail_sdm_7'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_sdm(' + response['result_detail_sdm_7'][i].id_detail_sdm_7 + ',4.8' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_sdm_7'][i].no_urut_7_sdm + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_10_sdm(ket, id, id_detail_sdm_6) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_11_sdm(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_11_sdm') {
                    Question_level_11_sdm(response['row_sdm_detail_8'].nama_uraian_8_sdm, response['row_sdm_detail_8'].id_detail_sdm_8, response['row_sdm_detail_8'].id_detail_sdm_7)
                }
                // _11
                if (type == 'urutan_level_11_sdm') {
                    modal_sdm_urutan.modal('show')
                    ...
                    for (i = 0; i < response['result_detail_sdm_8'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_sdm(' + response['result_detail_sdm_8'][i].id_detail_sdm_8 + ',4.9' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_sdm_8'][i].no_urut_8_sdm + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_11_sdm(ket, id, id_detail_sdm_7) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
...
<script>
    ...
    function modal_level_12_sdm(id, type, type_add) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (type == 'hapus_level_12_sdm') {
                    Question_level_12_sdm(response['row_sdm_detail_9'].nama_uraian_9_sdm, response['row_sdm_detail_9'].id_detail_sdm_9, response['row_sdm_detail_9'].id_detail_sdm_8)
                }
                ...
                if (type == 'urutan_level_12_sdm') {
                    ...
                    for (i = 0; i < response['result_detail_sdm_9'].length; ++i) {
                        html += '<tr>' +
                            '<td><input type="text" onkeyup="UbahUrutaan_sdm(' + response['result_detail_sdm_9'][i].id_detail_sdm_9 + ',4.10' + ',' + kirim_inisial++ + ')" name="no_urut_ubah_' + no++ + '" value="' + response['result_detail_sdm_9'][i].no_urut_9_sdm + '" class="form-control form-control-sm"></td>' +
    ...
    function Question_level_12_sdm(ket, id, id_detail_sdm_8) {
        Swal.fire({
            title: "Apakah Anda Yakin!?",
            text: 'Ingin Menghapus Data ' + ket + "?",
            icon: "warning",
