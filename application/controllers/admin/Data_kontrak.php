...
class Data_kontrak extends CI_Controller
{
            ...
            if ($rs->jenis_kontrak == 'Unit Price') {
                if ($rs->id_kontrak == 1) {
                    $row[] = '<div class="input-group mb-3">
                         ...
                         <a class="dropdown-item " href="javascript:;" class="btn btn-warning btn-sm" onClick="byid(' . "'" . $rs->id_kontrak . "','kelola_level_unit_price'" . ')"><i class="fa fa-file-contract"></i> Kelola Level</a>
                ...
                if ($rs->id_kontrak == 1) {
                    $row[] = '<div class="input-group mb-3">
                         ...
                         <div class="dropdown-menu">
                         <a class="dropdown-item " href="javascript:;" class="btn btn-warning btn-sm" onClick="byid(' . "'" . $rs->id_kontrak . "','kelola_level'" . ')"><i class="fa fa-file-contract"></i> Kelola Level</a>
    ...
    public function hapus_induk_level_3_capex($id_capex_detail)
    {
        ...
        $id_capex = $this->input->post('id_capex');
        $this->db->select('*');
        $this->db->from('tbl_capex_detail');
        $this->db->where('tbl_capex_detail.id_capex', $id_capex);
    ...
    public function hapus_induk_level_4_capex($id_detail_capex_1)
    {
        ...
        $this->db->from('tbl_detail_capex_1');
        $this->db->where('tbl_detail_capex_1.id_capex_detail', $id_capex_detail);
        $query_detail_capex_result_1 = $this->db->get()->result_array();
        $total_detail_capex_1 = 0;
        foreach ($query_detail_capex_result_1 as $key => $value_detail_capex_1) {
        ...
        $this->Data_kontrak_model->update_tbl_capex_detail($where, $data);
        $row_detail_capex = $this->Data_kontrak_model->by_id_capex_detail($id_capex_detail);
        $id_capex = $row_detail_capex['id_capex'];
        $this->db->select('*');
        $this->db->from('tbl_capex_detail');
        $this->db->where('tbl_capex_detail.id_capex', $id_capex);
        $query_detail_capex_result = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_5_capex($id_detail_capex_2)
    {
        ...
        $row_detail_capex_1 = $this->Data_kontrak_model->by_id_detail_capex_1($id_detail_capex_1);
        $id_capex_detail = $row_detail_capex_1['id_capex_detail'];
        $this->db->select('*');
        $this->db->from('tbl_detail_capex_1');
        $this->db->where('tbl_detail_capex_1.id_capex_detail', $id_capex_detail);
        $query_detail_capex_result_1 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_6_capex($id_detail_capex_3)
    {
        ...
        $row_detail_capex_2 = $this->Data_kontrak_model->by_id_detail_capex_2($id_detail_capex_2);
        $id_detail_capex_1 = $row_detail_capex_2['id_detail_capex_1'];
        $this->db->select('*');
        $this->db->from('tbl_detail_capex_2');
        $this->db->where('tbl_detail_capex_2.id_detail_capex_1', $id_detail_capex_1);
        $query_detail_capex_result_2 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_7_capex($id_detail_capex_4)
    {
        ...
        $this->Data_kontrak_model->update_tbl_detail_capex_3($where, $data);
        $row_detail_capex_3 = $this->Data_kontrak_model->by_id_detail_capex_3($id_detail_capex_3);
        $id_detail_capex_2 = $row_detail_capex_3['id_detail_capex_2'];
        $this->db->select('*');
        $this->db->from('tbl_detail_capex_3');
        $this->db->where('tbl_detail_capex_3.id_detail_capex_2', $id_detail_capex_2);
        $query_detail_capex_result_3 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_8_capex($id_detail_capex_5)
    {
        ...
        $this->Data_kontrak_model->update_tbl_detail_capex_4($where, $data);
        $row_detail_capex_4 = $this->Data_kontrak_model->by_id_detail_capex_4($id_detail_capex_4);
        $id_detail_capex_3 = $row_detail_capex_4['id_detail_capex_3'];
        $this->db->select('*');
        $this->db->from('tbl_detail_capex_4');
        $this->db->where('tbl_detail_capex_4.id_detail_capex_3', $id_detail_capex_3);
        $query_detail_capex_result_4 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_9_capex($id_detail_capex_6)
    {
        ...
        $this->Data_kontrak_model->update_tbl_detail_capex_5($where, $data);
        $row_detail_capex_5 = $this->Data_kontrak_model->by_id_detail_capex_5($id_detail_capex_5);
        $id_detail_capex_4 = $row_detail_capex_5['id_detail_capex_4'];
        $this->db->select('*');
        $this->db->from('tbl_detail_capex_5');
        $this->db->where('tbl_detail_capex_5.id_detail_capex_4', $id_detail_capex_4);
        $query_detail_capex_result_5 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_10_capex($id_detail_capex_7)
    {
        ...
        $this->Data_kontrak_model->update_tbl_detail_capex_6($where, $data);
        $row_detail_capex_6 = $this->Data_kontrak_model->by_id_detail_capex_6($id_detail_capex_6);
        $id_detail_capex_5 = $row_detail_capex_6['id_detail_capex_5'];
        // end ambil
    ...
    public function hapus_induk_level_11_capex($id_detail_capex_8)
    {
        ...
        foreach ($query_detail_capex_result_8 as $key => $value_detail_capex_7) {
            $total_detail_capex_8 +=  $value_detail_capex_7['nilai_capex_detail_7'];
        };
        $where = [
            'id_detail_capex_7' => $id_detail_capex_7,
        ];
        ...
        $this->Data_kontrak_model->update_tbl_detail_capex_7($where, $data);
        $row_detail_capex_7 = $this->Data_kontrak_model->by_id_detail_capex_7($id_detail_capex_7);
        $id_detail_capex_6 = $row_detail_capex_7['id_detail_capex_6'];
        // end ambil
        $this->db->select('*');
        $this->db->from('tbl_detail_capex_7');
        $this->db->where('tbl_detail_capex_7.id_detail_capex_6', $id_detail_capex_6);
    ...
    public function hapus_induk_level_12_capex($id_detail_capex_9)
    {
        ...
        foreach ($query_detail_capex_result_9 as $key => $value_detail_capex_9) {
            $total_detail_capex_9 +=  $value_detail_capex_9['nilai_capex_detail_8'];
        };
        $where = [
            'id_detail_capex_8' => $id_detail_capex_8,
        ];
        ...
        $this->Data_kontrak_model->update_tbl_detail_capex_8($where, $data);
        $row_detail_capex_8 = $this->Data_kontrak_model->by_id_detail_capex_8($id_detail_capex_8);
        $id_detail_capex_7 = $row_detail_capex_8['id_detail_capex_7'];
        $this->db->select('*');
        $this->db->from('tbl_detail_capex_8');
        $this->db->where('tbl_detail_capex_8.id_detail_capex_7', $id_detail_capex_7);
        $query_detail_capex_result_8 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_3_opex($id_opex_detail)
    {
        ...
        $id_opex = $this->input->post('id_opex');
        $this->db->select('*');
        $this->db->from('tbl_opex_detail');
        $this->db->where('tbl_opex_detail.id_opex', $id_opex);
        ...
        $data = [
            'nilai_kontrak_awal' => $total_opex + $total_opex + $total_bua + $total_sdm,
        ];
        $this->Data_kontrak_model->update_kontrak($where, $data);
    ...
    public function hapus_induk_level_4_opex($id_detail_opex_1)
    {
        ...
        $this->db->from('tbl_detail_opex_1');
        $this->db->where('tbl_detail_opex_1.id_opex_detail', $id_opex_detail);
        $query_detail_opex_result_1 = $this->db->get()->result_array();
        $total_detail_opex_1 = 0;
        foreach ($query_detail_opex_result_1 as $key => $value_detail_opex_1) {
        ...
        $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
        $row_detail_opex = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
        $id_opex = $row_detail_opex['id_opex'];
        $this->db->select('*');
        $this->db->from('tbl_opex_detail');
        $this->db->where('tbl_opex_detail.id_opex', $id_opex);
        $query_detail_opex_result = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_5_opex($id_detail_opex_2)
    {
        ...
        $row_detail_opex_1 = $this->Data_kontrak_model->by_id_detail_opex_1($id_detail_opex_1);
        $id_opex_detail = $row_detail_opex_1['id_opex_detail'];
        $this->db->select('*');
        $this->db->from('tbl_detail_opex_1');
        $this->db->where('tbl_detail_opex_1.id_opex_detail', $id_opex_detail);
        $query_detail_opex_result_1 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_6_opex($id_detail_opex_3)
    {
        ...
        $row_detail_opex_2 = $this->Data_kontrak_model->by_id_detail_opex_2($id_detail_opex_2);
        $id_detail_opex_1 = $row_detail_opex_2['id_detail_opex_1'];
        $this->db->select('*');
        $this->db->from('tbl_detail_opex_2');
        $this->db->where('tbl_detail_opex_2.id_detail_opex_1', $id_detail_opex_1);
        $query_detail_opex_result_2 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_7_opex($id_detail_opex_4)
    {
        ...
        $this->Data_kontrak_model->update_tbl_detail_opex_3($where, $data);
        $row_detail_opex_3 = $this->Data_kontrak_model->by_id_detail_opex_3($id_detail_opex_3);
        $id_detail_opex_2 = $row_detail_opex_3['id_detail_opex_2'];
        $this->db->select('*');
        $this->db->from('tbl_detail_opex_3');
        $this->db->where('tbl_detail_opex_3.id_detail_opex_2', $id_detail_opex_2);
        $query_detail_opex_result_3 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_8_opex($id_detail_opex_5)
    {
        ...
        $this->Data_kontrak_model->update_tbl_detail_opex_4($where, $data);
        $row_detail_opex_4 = $this->Data_kontrak_model->by_id_detail_opex_4($id_detail_opex_4);
        $id_detail_opex_3 = $row_detail_opex_4['id_detail_opex_3'];
        $this->db->select('*');
        $this->db->from('tbl_detail_opex_4');
        $this->db->where('tbl_detail_opex_4.id_detail_opex_3', $id_detail_opex_3);
        $query_detail_opex_result_4 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_9_opex($id_detail_opex_6)
    {
        ...
        $this->Data_kontrak_model->update_tbl_detail_opex_5($where, $data);
        $row_detail_opex_5 = $this->Data_kontrak_model->by_id_detail_opex_5($id_detail_opex_5);
        $id_detail_opex_4 = $row_detail_opex_5['id_detail_opex_4'];
        $this->db->select('*');
        $this->db->from('tbl_detail_opex_5');
        $this->db->where('tbl_detail_opex_5.id_detail_opex_4', $id_detail_opex_4);
        $query_detail_opex_result_5 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_10_opex($id_detail_opex_7)
    {
        ...
        $this->Data_kontrak_model->update_tbl_detail_opex_6($where, $data);
        $row_detail_opex_6 = $this->Data_kontrak_model->by_id_detail_opex_6($id_detail_opex_6);
        $id_detail_opex_5 = $row_detail_opex_6['id_detail_opex_5'];
        // end ambil
    ...
    public function hapus_induk_level_11_opex($id_detail_opex_8)
    {
        ...
        foreach ($query_detail_opex_result_8 as $key => $value_detail_opex_7) {
            $total_detail_opex_8 +=  $value_detail_opex_7['nilai_opex_detail_7'];
        };
        $where = [
            'id_detail_opex_7' => $id_detail_opex_7,
        ];
        ...
        $this->Data_kontrak_model->update_tbl_detail_opex_7($where, $data);
        $row_detail_opex_7 = $this->Data_kontrak_model->by_id_detail_opex_7($id_detail_opex_7);
        $id_detail_opex_6 = $row_detail_opex_7['id_detail_opex_6'];
        // end ambil
        $this->db->select('*');
        $this->db->from('tbl_detail_opex_7');
        $this->db->where('tbl_detail_opex_7.id_detail_opex_6', $id_detail_opex_6);
    ...
    public function hapus_induk_level_12_opex($id_detail_opex_9)
    {
        ...
        $query_detail_opex_result_9 = $this->db->get()->result_array();
        $total_detail_opex_9 = 0;
        foreach ($query_detail_opex_result_9 as $key => $value_detail_opex_9) {
            $total_detail_opex_9 +=  $value_detail_opex_9['nilai_opex_detail_8'];
        };
        $where = [
            'id_detail_opex_8' => $id_detail_opex_8,
        ];
        $data = [
            'nilai_opex_detail_8' => $total_detail_opex_9,
        ];
        $this->Data_kontrak_model->update_tbl_detail_opex_8($where, $data);
        $row_detail_opex_8 = $this->Data_kontrak_model->by_id_detail_opex_8($id_detail_opex_8);
        $id_detail_opex_7 = $row_detail_opex_8['id_detail_opex_7'];
        $this->db->select('*');
        $this->db->from('tbl_detail_opex_8');
        $this->db->where('tbl_detail_opex_8.id_detail_opex_7', $id_detail_opex_7);
        $query_detail_opex_result_8 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_3_bua($id_bua_detail)
    {
        ...
        $data = [
            'nilai_kontrak_awal' => $total_bua + $total_opex + $total_bua + $total_sdm,
        ];
        $this->Data_kontrak_model->update_kontrak($where, $data);
    ...
    public function hapus_induk_level_4_bua($id_detail_bua_1)
    {
        ...
        $query_detail_bua_result_1 = $this->db->get()->result_array();
        $total_detail_bua_1 = 0;
        foreach ($query_detail_bua_result_1 as $key => $value_detail_bua_1) {
        ...
        $this->Data_kontrak_model->update_tbl_bua_detail($where, $data);
        $row_detail_bua = $this->Data_kontrak_model->by_id_bua_detail($id_bua_detail);
        $id_bua = $row_detail_bua['id_bua'];
        $this->db->select('*');
        $this->db->from('tbl_bua_detail');
        $this->db->where('tbl_bua_detail.id_bua', $id_bua);
        $query_detail_bua_result = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_5_bua($id_detail_bua_2)
    {
        ...
        $row_detail_bua_1 = $this->Data_kontrak_model->by_id_detail_bua_1($id_detail_bua_1);
        $id_bua_detail = $row_detail_bua_1['id_bua_detail'];
        $this->db->select('*');
        $this->db->from('tbl_detail_bua_1');
        $this->db->where('tbl_detail_bua_1.id_bua_detail', $id_bua_detail);
        $query_detail_bua_result_1 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_6_bua($id_detail_bua_3)
    {
        ...
        $row_detail_bua_2 = $this->Data_kontrak_model->by_id_detail_bua_2($id_detail_bua_2);
        $id_detail_bua_1 = $row_detail_bua_2['id_detail_bua_1'];
        $this->db->select('*');
        $this->db->from('tbl_detail_bua_2');
        $this->db->where('tbl_detail_bua_2.id_detail_bua_1', $id_detail_bua_1);
        $query_detail_bua_result_2 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_7_bua($id_detail_bua_4)
    {
        ...
        $this->Data_kontrak_model->update_tbl_detail_bua_3($where, $data);
        $row_detail_bua_3 = $this->Data_kontrak_model->by_id_detail_bua_3($id_detail_bua_3);
        $id_detail_bua_2 = $row_detail_bua_3['id_detail_bua_2'];
        $this->db->select('*');
        $this->db->from('tbl_detail_bua_3');
        $this->db->where('tbl_detail_bua_3.id_detail_bua_2', $id_detail_bua_2);
        $query_detail_bua_result_3 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_8_bua($id_detail_bua_5)
    {
        ...
        $this->Data_kontrak_model->update_tbl_detail_bua_4($where, $data);
        $row_detail_bua_4 = $this->Data_kontrak_model->by_id_detail_bua_4($id_detail_bua_4);
        $id_detail_bua_3 = $row_detail_bua_4['id_detail_bua_3'];
        $this->db->select('*');
        $this->db->from('tbl_detail_bua_4');
        $this->db->where('tbl_detail_bua_4.id_detail_bua_3', $id_detail_bua_3);
        $query_detail_bua_result_4 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_9_bua($id_detail_bua_6)
    {
        ...
        $this->Data_kontrak_model->update_tbl_detail_bua_5($where, $data);
        $row_detail_bua_5 = $this->Data_kontrak_model->by_id_detail_bua_5($id_detail_bua_5);
        $id_detail_bua_4 = $row_detail_bua_5['id_detail_bua_4'];
        $this->db->select('*');
        $this->db->from('tbl_detail_bua_5');
        $this->db->where('tbl_detail_bua_5.id_detail_bua_4', $id_detail_bua_4);
        $query_detail_bua_result_5 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_10_bua($id_detail_bua_7)
    {
        ...
        $this->Data_kontrak_model->update_tbl_detail_bua_6($where, $data);
        $row_detail_bua_6 = $this->Data_kontrak_model->by_id_detail_bua_6($id_detail_bua_6);
        $id_detail_bua_5 = $row_detail_bua_6['id_detail_bua_5'];
        // end ambil
    ...
    public function hapus_induk_level_11_bua($id_detail_bua_8)
    {
        ...
        foreach ($query_detail_bua_result_8 as $key => $value_detail_bua_7) {
            $total_detail_bua_8 +=  $value_detail_bua_7['nilai_bua_detail_7'];
        };
        $where = [
            'id_detail_bua_7' => $id_detail_bua_7,
        ];
        ...
        $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
        $row_detail_bua_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
        $id_detail_bua_6 = $row_detail_bua_7['id_detail_bua_6'];
        // end ambil
        $this->db->select('*');
        $this->db->from('tbl_detail_bua_7');
        $this->db->where('tbl_detail_bua_7.id_detail_bua_6', $id_detail_bua_6);
    ...
    public function hapus_induk_level_12_bua($id_detail_bua_9)
    {
        ...
        foreach ($query_detail_bua_result_9 as $key => $value_detail_bua_9) {
            $total_detail_bua_9 +=  $value_detail_bua_9['nilai_bua_detail_8'];
        };
        $where = [
            'id_detail_bua_8' => $id_detail_bua_8,
        ];
        ...
        $this->Data_kontrak_model->update_tbl_detail_bua_8($where, $data);
        $row_detail_bua_8 = $this->Data_kontrak_model->by_id_detail_bua_8($id_detail_bua_8);
        $id_detail_bua_7 = $row_detail_bua_8['id_detail_bua_7'];
        $this->db->select('*');
        $this->db->from('tbl_detail_bua_8');
        $this->db->where('tbl_detail_bua_8.id_detail_bua_7', $id_detail_bua_7);
        $query_detail_bua_result_8 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_3_sdm($id_sdm_detail)
    {
        ...
        $data = [
            'nilai_kontrak_awal' => $total_sdm + $total_opex + $total_bua + $total_sdm,
        ];
        $this->Data_kontrak_model->update_kontrak($where, $data);
    ...
    public function hapus_induk_level_4_sdm($id_detail_sdm_1)
    {
        ...
        $query_detail_sdm_result_1 = $this->db->get()->result_array();
        $total_detail_sdm_1 = 0;
        foreach ($query_detail_sdm_result_1 as $key => $value_detail_sdm_1) {
        ...
        $this->Data_kontrak_model->update_tbl_sdm_detail($where, $data);
        $row_detail_sdm = $this->Data_kontrak_model->by_id_sdm_detail($id_sdm_detail);
        $id_sdm = $row_detail_sdm['id_sdm'];
        $this->db->select('*');
        $this->db->from('tbl_sdm_detail');
        $this->db->where('tbl_sdm_detail.id_sdm', $id_sdm);
        $query_detail_sdm_result = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_5_sdm($id_detail_sdm_2)
    {
        ...
        $row_detail_sdm_1 = $this->Data_kontrak_model->by_id_detail_sdm_1($id_detail_sdm_1);
        $id_sdm_detail = $row_detail_sdm_1['id_sdm_detail'];
        $this->db->select('*');
        $this->db->from('tbl_detail_sdm_1');
        $this->db->where('tbl_detail_sdm_1.id_sdm_detail', $id_sdm_detail);
        $query_detail_sdm_result_1 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_6_sdm($id_detail_sdm_3)
    {
        ...
        $row_detail_sdm_2 = $this->Data_kontrak_model->by_id_detail_sdm_2($id_detail_sdm_2);
        $id_detail_sdm_1 = $row_detail_sdm_2['id_detail_sdm_1'];
        $this->db->select('*');
        $this->db->from('tbl_detail_sdm_2');
        $this->db->where('tbl_detail_sdm_2.id_detail_sdm_1', $id_detail_sdm_1);
        $query_detail_sdm_result_2 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_7_sdm($id_detail_sdm_4)
    {
        ...
        $this->Data_kontrak_model->update_tbl_detail_sdm_3($where, $data);
        $row_detail_sdm_3 = $this->Data_kontrak_model->by_id_detail_sdm_3($id_detail_sdm_3);
        $id_detail_sdm_2 = $row_detail_sdm_3['id_detail_sdm_2'];
        $this->db->select('*');
        $this->db->from('tbl_detail_sdm_3');
        $this->db->where('tbl_detail_sdm_3.id_detail_sdm_2', $id_detail_sdm_2);
        $query_detail_sdm_result_3 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_8_sdm($id_detail_sdm_5)
    {
        ...
        $this->Data_kontrak_model->update_tbl_detail_sdm_4($where, $data);
        $row_detail_sdm_4 = $this->Data_kontrak_model->by_id_detail_sdm_4($id_detail_sdm_4);
        $id_detail_sdm_3 = $row_detail_sdm_4['id_detail_sdm_3'];
        $this->db->select('*');
        $this->db->from('tbl_detail_sdm_4');
        $this->db->where('tbl_detail_sdm_4.id_detail_sdm_3', $id_detail_sdm_3);
        $query_detail_sdm_result_4 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_9_sdm($id_detail_sdm_6)
    {
        ...
        $this->Data_kontrak_model->update_tbl_detail_sdm_5($where, $data);
        $row_detail_sdm_5 = $this->Data_kontrak_model->by_id_detail_sdm_5($id_detail_sdm_5);
        $id_detail_sdm_4 = $row_detail_sdm_5['id_detail_sdm_4'];
        $this->db->select('*');
        $this->db->from('tbl_detail_sdm_5');
        $this->db->where('tbl_detail_sdm_5.id_detail_sdm_4', $id_detail_sdm_4);
        $query_detail_sdm_result_5 = $this->db->get()->result_array();
    ...
    public function hapus_induk_level_10_sdm($id_detail_sdm_7)
    {
        ...
        $this->Data_kontrak_model->update_tbl_detail_sdm_6($where, $data);
        $row_detail_sdm_6 = $this->Data_kontrak_model->by_id_detail_sdm_6($id_detail_sdm_6);
        $id_detail_sdm_5 = $row_detail_sdm_6['id_detail_sdm_5'];
        // end ambil
    ...
    public function hapus_induk_level_11_sdm($id_detail_sdm_8)
    {
        ...
        foreach ($query_detail_sdm_result_8 as $key => $value_detail_sdm_7) {
            $total_detail_sdm_8 +=  $value_detail_sdm_7['nilai_sdm_detail_7'];
        };
        $where = [
            'id_detail_sdm_7' => $id_detail_sdm_7,
        ];
        ...
        $this->Data_kontrak_model->update_tbl_detail_sdm_7($where, $data);
        $row_detail_sdm_7 = $this->Data_kontrak_model->by_id_detail_sdm_7($id_detail_sdm_7);
        $id_detail_sdm_6 = $row_detail_sdm_7['id_detail_sdm_6'];
        // end ambil
        $this->db->select('*');
        $this->db->from('tbl_detail_sdm_7');
        $this->db->where('tbl_detail_sdm_7.id_detail_sdm_6', $id_detail_sdm_6);
    ...
    public function hapus_induk_level_12_sdm($id_detail_sdm_9)
    {
        ...
        foreach ($query_detail_sdm_result_9 as $key => $value_detail_sdm_9) {
            $total_detail_sdm_9 +=  $value_detail_sdm_9['nilai_sdm_detail_8'];
        };
        $where = [
            'id_detail_sdm_8' => $id_detail_sdm_8,
        ];
        ...
        $this->Data_kontrak_model->update_tbl_detail_sdm_8($where, $data);
        $row_detail_sdm_8 = $this->Data_kontrak_model->by_id_detail_sdm_8($id_detail_sdm_8);
        $id_detail_sdm_7 = $row_detail_sdm_8['id_detail_sdm_7'];
        $this->db->select('*');
        $this->db->from('tbl_detail_sdm_8');
        $this->db->where('tbl_detail_sdm_8.id_detail_sdm_7', $id_detail_sdm_7);
        $query_detail_sdm_result_8 = $this->db->get()->result_array();
