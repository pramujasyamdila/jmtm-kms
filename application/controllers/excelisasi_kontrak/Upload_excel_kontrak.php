...
class Upload_excel_kontrak extends CI_Controller
{
    ...
    public function upload_data_excel_capex()
    {
        ...
        $this->Data_excelisasi_model->delete_tbl_capex_detail($id_capex);
    ...
    public function upload_data_excel_detail_capex_1()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_capex_1($id_capex_detail);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_capex_2()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_capex_2($id_detail_capex_1);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_capex_3()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_capex_3($id_detail_capex_2);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_capex_4()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_capex_4($id_detail_capex_3);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_capex_5()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_capex_5($id_detail_capex_4);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_capex_6()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_capex_6($id_detail_capex_5);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_capex_7()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_capex_7($id_detail_capex_6);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_capex_8()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_capex_8($id_detail_capex_7);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_capex_9()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_capex_9($id_detail_capex_8);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_opex()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_opex_detail($id_opex);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_opex_1()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_opex_1($id_opex_detail);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_opex_2()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_opex_2($id_detail_opex_1);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_opex_3()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_opex_3($id_detail_opex_2);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_opex_4()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_opex_4($id_detail_opex_3);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_opex_5()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_opex_5($id_detail_opex_4);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_opex_6()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_opex_6($id_detail_opex_5);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_opex_7()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_opex_7($id_detail_opex_6);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_opex_8()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_opex_8($id_detail_opex_7);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_opex_9()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_opex_9($id_detail_opex_8);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_bua()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_bua_detail($id_bua);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_bua_1()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_bua_1($id_bua_detail);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_bua_2()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_bua_2($id_detail_bua_1);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_bua_3()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_bua_3($id_detail_bua_2);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_bua_4()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_bua_4($id_detail_bua_3);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_bua_5()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_bua_5($id_detail_bua_4);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_bua_6()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_bua_6($id_detail_bua_5);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_bua_7()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_bua_7($id_detail_bua_6);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_bua_8()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_bua_8($id_detail_bua_7);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_bua_9()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_bua_9($id_detail_bua_8);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_sdm()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_sdm_detail($id_sdm);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_sdm_1()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_sdm_1($id_sdm_detail);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_sdm_2()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_sdm_2($id_detail_sdm_1);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_sdm_3()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_sdm_3($id_detail_sdm_2);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_sdm_4()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_sdm_4($id_detail_sdm_3);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_sdm_5()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_sdm_5($id_detail_sdm_4);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_sdm_6()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_sdm_6($id_detail_sdm_5);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_sdm_7()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_sdm_7($id_detail_sdm_6);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_sdm_8()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_sdm_8($id_detail_sdm_7);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
    ...
    public function upload_data_excel_detail_sdm_9()
    {
        ...
        $id_kontrak = $this->input->post('id_kontrak');
        $type_add = $this->input->post('type_add_excel');
        $this->Data_excelisasi_model->delete_tbl_detail_sdm_9($id_detail_sdm_8);
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'xlsx|xls';
        $config['file_name'] = 'doc' . time();
        $this->load->library('upload', $config);
